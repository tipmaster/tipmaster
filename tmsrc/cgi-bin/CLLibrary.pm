...
sub getTimeLimit {
	...
	my $derzeitige_runde = $self->getCurrentCLRound();
        ...
        $lfdsais +=67;
        my $weekctr = ($lfdsais*9)+425+46+2+55+54+5+2+2+6+2+1;   
	#2017-12-20: Added 2 weeks XMas break
	#2018-12-27: Added 1 week of XMas break
	#2023-12-30: Added 1 week of XMas break
	#2024-12-29: Added 1 week of XMas break
        #####
	...
	if ($nowtime > 1603576800 && $nowtime < 1616886000) { #Oct 25 - Mar 28 2021
	   $winterzeit = 1;
        ...
        if ($nowtime > 1698682849 && $nowtime < 1711898449) { #Oct 30 - Mar 26 2024
           $winterzeit = 1;
        }
        if ($nowtime > 1730046049 && $nowtime < 1743348049) { #Oct 30 - Mar 26 2025
           $winterzeit = 1;
        }
