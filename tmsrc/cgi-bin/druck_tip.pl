...
print "<table border=0 cellpadding=1 cellspacing=0><tr><td align=center bgcolor=black><SPACER TYPE=BLOCK WIDTH=1 HEIGHT=1></td><td><SPACER TYPE=BLOCK WIDTH=1 HEIGHT=1></td><td>";
...
$tmp="";$tmp1="";
if ($ergebnis[$all[$dd]] != 0 && $ergebnis[$all[$dd]] == $all[$dd-1]){ $tmp ="<font color=green>";$tmp1="<font color=black>"}
if ($ergebnis[$all[$dd]] != 0 && $ergebnis[$all[$dd]] != $all[$dd-1]){ $tmp ="<font color=red>";$tmp1="<font color=black>"}
