...
if ($perc) {
  ...
  my @perc = (int($toto_1[$x]*100/$sum),int($toto_2[$x]*100/$sum),int($toto_3[$x]*100/$sum));
  print "<td align=center bgcolor=$color><font face=verdana size=1 color=black>(",$perc[0],"-",$perc[1],"-",$perc[2],")</font></td>";
}
