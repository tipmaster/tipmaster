...
print "<font size=1> &nbsp; <a href=/cgi-bin/btm/friendly.pl?method=liste>Bereits fixe Freundschaftsspiele diese Woche</a><br><br>\n";
...
print "<td align=left bgcolor=$farbe>&nbsp;&nbsp;&nbsp;&nbsp;<font face=verdana size=1><img src=/img/$flag width=14 height=10 border=0>&nbsp;&nbsp;&nbsp;$paarung[$x]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>\n";
}
...
print "<font face=verdana size=2><b>( $spiel Spiele ) &nbsp; &nbsp; <input type=submit value=\"Spiele laden\" style=\"font-family: Verdana; font-size: 11px; font-weight: normal; color: #000000;\"></form>";
print "<form method=post action=/cgi-bin/btm/friendly.pl target=_top>\n";
...
print "&nbsp; <a href=/cgi-bin/btm/friendly.pl?huni=$hu&method=liste&akt_runde=$akt_runde>Spiel $xx bis $xy</a> &nbsp; ";
$li=1;
}
