...
print
"<html><title>Tipabgabe Freundschaftsspiel</title><body bgcolor=#eeeeee text=black vlink=blue link=blue><font face=verdana size=1><center>\n";
...
if ( $pro1[1] == 0 ) {
	print
"<center><br><br><font face=verdana size=2><b>Die beiden Tipabgaben fuer dieses Spiel sind noch<br>nicht erfolgt bzw. noch nicht zur Einsicht freigegeben.<br><br><font color=darkred> Die Tipabgaben der aktuellen Spielrunde sind<br>ab Freitags 18.oo Uhr hier einsehbar.";
	exit;
}
...
print "</font></td>\n";
print
"<td align=left width=250 valign=middle><font face=verdana size=1><img src=/img/loch.JPG border=0><br><font color=black>\n";
for ( $x = 1 ; $x < 6 ; $x++ ) {

	$flag = $main_flags[ $flagge[ $sp1[$x] ] ];

	print
"&nbsp;&nbsp;&nbsp;&nbsp;<img HEIGHT=10 WIDTH=14 src=http://www.tipmaster.de/img/$flag border=0>&nbsp;&nbsp;&nbsp;&nbsp;<a href=javascript:document.xr$x.submit()>$paarung[$sp1[$x]]</a><br>\n";
...
print "</td>\n";
print
"<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td align=left valign=top><font face=verdana size=1><img src=http://www.tipmaster.de/img/loch.JPG><br>\n";
...
for ( $x = 1 ; $x < 6 ; $x++ ) {
	...
	print
"&nbsp;&nbsp;&nbsp;&nbsp;<img HEIGHT=10 WIDTH=14 src=http://www.tipmaster.de/img/$flag border=0>&nbsp;&nbsp;&nbsp;&nbsp;<a href=javascript:document.xs$x.submit()>$paarung[$sp2[$x]]</a><br>\n";
...
print "</td>\n";
print
"<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td align=left valign=top><font face=verdana size=1><img src=/img/loch.JPG><br>\n";
