...
print "Bundesliga - TipMaster<br><br>Ihr altes Passwort ist falsch ...";
exit ;
}
...
print "Content-type: text/html\n\n";
print "<body bgcolor=#eeeeee text=black><font face=verdana size=1>";
print "Bundesliga - TipMaster<br><br>Ihr neues Passwort ist ungueltig .<br>Bitte verzichten Sie auf Umlaute , Sonderzeichen und Leerstellen in ihrem Passwort ...";
exit ;
}
...
print "Content-type: text/html\n\n";
print "<body bgcolor=#eeeeee text=black><font face=verdana size=1>";
print "Bundesliga - TipMaster<br><br>Ihr neues Passwort ist zu kurz.<br>Ihr Passwort muss mind. 6 Zeichen lang sein ...";
exit ;
}
...
print "Content-type: text/html\n\n";
print "<body bgcolor=#eeeeee text=black><font face=verdana size=1>";
print "Bundesliga - TipMaster<br><br>Ihre Passwort wurde in $pass2 geaendert ...";
