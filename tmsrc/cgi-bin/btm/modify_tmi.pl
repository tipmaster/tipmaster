...
if (!$trainer) {
	print "<b1>Ung&uuml;ltiger Aufruf!</b1> Bitte vom <a href=\"/cgi-bin/btm/scout.pl\">Scout-Formular</a> aus aufrufen!<br>\n";
	print "</body></html>\n";
	exit 0;
}
...
print DO "\n\n";
for ($y=1;$y<=25;$y++) {
print DO "$flagge[$y]&$paarung_b[$y]&$qu_1_b[$y]&$qu_0_b[$y]&$qu_2_b[$y]&$pro[$y]&$erg[$y]&$datum_new[$y]&$zeit_new[$y]&\n";
...
$jahr = $jahr + 1900 ;
open(DO,">/tmdata/btm/scout_tmi.txt");
flock (DO, 2);
