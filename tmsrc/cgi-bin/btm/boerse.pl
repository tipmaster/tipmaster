...
print "      targetWin = open(URL,\"Neufenstere\",\"scrolling=auto,toolbar=no,directories=no,menubar=no,status=no,resizeable=yes,width=850,height=400\");\n";
print " }\n";
print "  //-->\n";
print "  </script>\n";
...
print "<tr bgcolor=#eeeeff><td align=center><font face=verdana size=1>Bundesliga - TipMaster Job Boerse<br></td></tr>";
...
print "<tr><td colspan=7 align=center bgcolor=#f6f4f4><font size=2>&nbsp; <font face=verdana size=1>Bundesliga - TipMaster Job - Boerse [ freie Vereine der 1.Bundesliga bis Bezirksliga]<br></td></tr>";

if ($inactive) {
print "<tr><td colspan=7 align=center><font face=verdana size=2 color=red>Wegen einer Fehlfunktion ist die Jobb&ouml;rse diese Woche leider ausser Betrieb. <br>Die ausgeschriebenen Vereine werden n&auml;chste Woche vergeben!</font></td></tr>\n";
}
...
print "<td align=center bgcolor=#cbccff><font face=verdana size=1>&nbsp; $liga_kuerzel[$auswahl_liga[$x]] &nbsp;</td>\n";
...
print "<td align=center bgcolor=#cbccff> &nbsp;&nbsp;<a href=/cgi-bin/btm/boerse_rank.pl?li=$auswahl_liga[$x]&ve=$auswahl_id[$x]&isa=$isa&isb=$isb target\"_blank\" onClick=\"targetLink('/cgi-bin/btm/boerse_rank.pl?li=$auswahl_liga[$x]&ve=$auswahl_id[$x]&isa=$isa&isb=$isb');return false\"><img src=/img/job.gif border=0></a>&nbsp;&nbsp;</td>\n";
...
print "-> &nbsp; <a href=javascript:document.wechsel.submit()>Bisherige Vereinswechsel / Vereinstaeusche dieser Saison</a><br><br><br>";
...
if ( $boerse_open ==1 ) {
print "&nbsp;<input style=\"font family:verdana;font-size:11px;\" type=submit value=\"Bewerbungen abschicken\">";
}
if ( $boerse_open ==0 ) {
...
print "<br><form name=wechsel method=post action=/cgi-bin/btm/boerse_wechsel.pl target=_top><input type=hidden name=loss value=\"$ligo\"></form>\n";
