...
print "<td align=left bgcolor=$farbe>&nbsp;&nbsp;&nbsp;&nbsp;<font face=verdana size=1><img HEIGHT=10 WIDTH=14 src=/img/$flag border=0>&nbsp;&nbsp;&nbsp;$paarung[$x]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>\n";
...
print "<td align=left bgcolor=$farbe nowrap>&nbsp;&nbsp;&nbsp;&nbsp;<font face=verdana size=1><img HEIGHT=10 WIDTH=14 src=/img/$flag border=0>&nbsp;&nbsp;&nbsp;$paarung[$x]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>\n";
...
print "<font face=verdana size=1 color=black><br>Beim Click auf die Laenderflaggen werden die entsprechenden realen Ligatabellen geladen .<br>Nach dem Absenden des Formulars unbedingt auf die Antwortseite warten !<br><br>Die Tippabgabe ist jeweils bis Freitags 18.oo Uhr moeglich !\n";
...
if ( $tip_status == 2 ) { print "Der Tippabgabetermin ist bereits abgelaufen .<br>Es ist keine Abgabe bzw. Aenderung Ihres Tips mehr moeglich .</html>\n"}
