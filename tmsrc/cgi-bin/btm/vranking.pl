...
for ( $t = 1 ; $t <= $rr ; $t++ ) {
	...
	if ( $ein == 1 ) {
		...
		print
"<td bgcolor=$colore align=left><font face=verdana size=1 color=$color>&nbsp;&nbsp;<a href=/cgi-mod/btm/verein.pl?ident=$aa><img src=/img/h1.jpg border=0 alt=\"Vereinsstatistik $verein[$ident[$t]]\"></a>&nbsp;&nbsp;$verein[$ident[$t]] &nbsp; &nbsp; &nbsp; </td>\n";
