...
print "<font face=verdana size=2 color=black><b>\n";
print "Vielen Dank $trainer fuer Ihre Tipabgabe<br>fuer Ihren Verein $data[$verein] !</b><br><font size=1><br>Bis Freitag 18.oo Uhr koennen Sie ihren Tip noch aendern .<br>\n";
...
print "<font face=verdana size=1 color=black><br>&nbsp;Auch keine Tipabgabe fuer relevante<br>&nbsp;und anstehende Pokalrunden vergessen ? <br>
<br>&nbsp;<font size=2><a href=/cgi-bin/cup_time.pl target=_new>Blick auf den Rahmenterminkalender</a> <br><br>";

if ( $mail_ja == 1 ) {
print "<font size=1>&nbsp;Ihr Tip wurde Ihnen auch an folgende E-Mail Adresse gemailt :<br><font color=darkred>&nbsp;$mail_adresse<font color=black>&nbsp;&nbsp; [ -> <a href=javascript:document.daten.submit()>E-Mail Adresse aendern</a> ]<br><br>";
}
print "
...
print"<br><form method=post action=/cgi-mod/btm/login.pl target=_top><input type=image src=/img/men_sta.gif border=0></form>\n";
...
$mail{Message} =  "*** Tipabgabe Bundesliga - TipMaster [ Tiprunde $rrunde / 9 ] ***        http://www.tipmaster.de \n\n";
