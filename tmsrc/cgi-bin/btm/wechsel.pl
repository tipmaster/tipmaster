...
print "<br><font color=darkred> &nbsp; &nbsp; Option gesperrt da unter Ihrem Namen bereits ein Vereinswechsel erfolgt ist in dieser Saison ! <br><br>";
} else {

print "<form method=post action=/cgi-bin/btm/wechsel.pl>".&hidden("me","direct")."<select name=verein $gl_{style}>\n";
foreach (@freeteams) {
