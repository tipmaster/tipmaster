...
print
"<font face=verdana size=1 color=darkgreen>Bevor Ihr ein Endergebnis eintragt, prueft dieses Ergebnis<br>bitte durch mindestens zwei unabhaenige Quellen<br>( z.B. <a href=http://www.kicker.de>kicker.de</a> , <a href=http://www.fussball-liveticker.eu>fussball-liveticker.eu</a> etc. )<br><br><font color=black>";
