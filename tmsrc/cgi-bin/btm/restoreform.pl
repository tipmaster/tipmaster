...
@accept = ( "Werner Stengl","Wally Dresel" ,  "Bodo Pfannenschwarz" ,
"Thomas Schnaedelbach" , "Walter Eschbaumer" , "Manfred Kiesel","Calvin Gross" , 
"Roberto Maisl","Stefan Imhoff","Rainer Mueller","Markus Reiss","Martin Ziegler","Sascha Lobers",
"Martin Forster","Thomas Sassmannshausen");
