...
close (D2) ;
print "<form action=/cgi-mod/btm/trainer.pl method=post name=x$xf target=new><input type=hidden name=ident value=\"$bewerber[$place[$xf]]\"></form>\n";

print "<td bgcolor=#eeeeff align=left><font face=verdana size=1 color=$color>&nbsp;&nbsp;<a href=javascript:document.x$xf.submit()><img src=/img/h1.jpg border=0 alt=\"Trainerstatistik $bewerber[$place[$xf]]\"></a>&nbsp;&nbsp;$bewerber[$place[$xf]]&nbsp;&nbsp;&nbsp;&nbsp; </td>\n";

print "<td bgcolor=#e3e4ff align=left><font face=verdana size=1>&nbsp;&nbsp;$bewerber_verein[$place[$xf]]&nbsp;&nbsp;</td>\n";
$space="";if ( $bewerber_verein_platz{$bewerber_verein[$place[$xf]]} < 10 ) { $space = 0 }
print "<td bgcolor=#e3e4ff align=right><font face=verdana size=1>&nbsp;&nbsp;$liga_kuerzel[$bewerber_verein_liga{$bewerber_verein[$place[$xf]]}] ($space$bewerber_verein_platz{$bewerber_verein[$place[$xf]]}.) &nbsp;</td>\n";
...
print "<td bgcolor=#e3e4ff align=center><font face=verdana size=1>&nbsp;&nbsp;$pu_a[$place[$xf]] + $pu_b[$place[$xf]]&nbsp;&nbsp;</td>\n";
