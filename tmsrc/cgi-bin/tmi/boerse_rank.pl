...
$bewerber_punkte_a[$xf] = $bewerber_punkte[$xf] ;
}
...
print "<tr><td colspan=5 align=center bgcolor=#d2d2d2><font face=verdana size=1>
...
close (D2) ;
print "<form action=http://www.tipmaster.de/cgi-mod/tmi/trainer.pl method=post name=x$xf target=new><input type=hidden name=ident value=\"$bewerber[$place[$xf]]\"></form>\n";

print "<td bgcolor=#eeeeff align=left><font face=verdana size=1 color=$color>&nbsp;&nbsp;<a href=javascript:document.x$xf.submit()><img src=http://www.tipmaster.de/img/h1.jpg border=0 alt=\"Trainerstatistik $bewerber[$place[$xf]]\"></a>&nbsp;&nbsp;$bewerber[$place[$xf]]&nbsp;&nbsp;&nbsp;&nbsp; </td>\n";

print "<td bgcolor=#e3e4ff align=left><font face=verdana size=1>&nbsp;&nbsp;$bewerber_verein[$place[$xf]]&nbsp;&nbsp;</td>\n";
print "<td bgcolor=#e3e4ff align=right><font face=verdana size=1>&nbsp;&nbsp;$liga_kuerzel[$bewerber_verein_liga{$bewerber_verein[$place[$xf]]}]&nbsp;&nbsp;[ KAT $liga_kat[$bewerber_verein_liga{$bewerber_verein[$place[$xf]]}] ] &nbsp; </td>\n";
...
print "<td bgcolor=#e3e4ff align=right><font face=verdana size=1>&nbsp;&nbsp;
$bewerber_punkte_a[$place[$xf]]&nbsp; + ",$bewerber_punkte[$place[$xf]] -
$bewerber_punkte_a[$place[$xf]],"
...
print "<br><center><font face=verdana size=1>&nbsp; Als Bewertungsgrundlage fuer die Vergabe der Trainerposten gilt zum einen der aktuelle Tabellenplatz<br>&nbsp; in der entprechenden Liga , sowie die persoenlichen erzielten Tore  der letzten drei Saisons .<br><br>Blau markierte Trainer haben in dieser Saison bereits einmal Ihren Verein ueber die<br>Job - Boerse gewechselt und werden daher bei der Vergabe nicht beruecksichtigt .\n";
