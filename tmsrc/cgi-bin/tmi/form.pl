...
$xb = $xa + 3;
if ( $xb > 34 ) { $xb = 34 }
print "<html><head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\"></head><title>Tipformular Ergebnisse</title><p align=left><body bgcolor=white text=black link=darkred link=darkred>\n";
...
print "<td align=left bgcolor=$color nowrap=nowrap><font face=verdana size=1>&nbsp;&nbsp;<img src=/img/$flag border=0 width=14 height=10>&nbsp;&nbsp;&nbsp;&nbsp;$paarung[$x]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>\n";
print "<td align=center bgcolor=$color><font face=verdana size=1>&nbsp;&nbsp;$resultat[$x]&nbsp;&nbsp;</td>\n";
print "<td align=center bgcolor=$color><font face=verdana size=1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>\n";
...
if ( $ergebnis[$x] == 4 ) 
{ $color1 = $color2 = $color3 = "red" ; $qu_1[$x] = $qu_0[$x] = $qu_2[$x] = 10}


print "<td align=center bgcolor=$color><font face=verdana size=1 color=$color1>&nbsp;&nbsp;$qu_1[$x]&nbsp;&nbsp;</td>\n";
print "<td align=center bgcolor=$color><font face=verdana size=1 color=$color2>&nbsp;&nbsp;$qu_0[$x]&nbsp;&nbsp;</td>\n";
print "<td align=center bgcolor=$color><font face=verdana size=1 color=$color3>&nbsp;&nbsp;$qu_2[$x]&nbsp;&nbsp;</td>\n";
