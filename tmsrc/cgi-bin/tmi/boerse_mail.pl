...
print "<form name=Testform action=/cgi-bin/tmi/boerse.pl method=post></form>";
...
if ( $bewerb != 0 ) {
print "<td valign=top align=left><br>\n";

require "/tmapp/tmsrc/cgi-bin/tag.pl" ;
require "/tmapp/tmsrc/cgi-bin/tag_small.pl" ;

print "<br><br><font face=verdana size=1>Sehr geehrte(r) $trainer ,<br><br>es wurden folgende Bewerbungen von Ihnen registriert :<br><br>\n";
...
print "<br><br>Sie werden in 5 Sek. zur Menuseite weiter geleitet ...</tr></table>";
}
...
print "<td valign=top align=left><br><font face=verdana size=1>Sehr geehrte(r) $trainer ,<br><br>es wurden von Ihnen keine Vereine zur Bewerbung ausgewaehlt<br>beziehungsweise alle ihre Bewerbungen wurden ruckgaengig gemacht .<br><br><br><br>Sie werden in 10 Sek. zur Menuseite weiter geleitet ...</td></tr></table>";
}
exit ;
