...
print "&nbsp;<b>TipMaster international Freundschaftsspiele</b><br><br>\n";
print "<font size=1> &nbsp; <a href=/cgi-bin/tmi/friendly.pl?method=liste>Bereits fixe Freundschaftsspiele diese Woche</a><br><br>\n";
print "<br><font size=2><font color=darkred><b> &nbsp; ~ Freundschaftspiel Angebot unterbreiten </b>\n";
print "<br><br><font color=black size=1> &nbsp; Suchen Sie nach dem Verein / Trainer gegen den Sie ein Freundschaftspiel bestreiten wollen :<br><br>\n";


print "<font face=verdana size=1>\n";

print "<form action=/cgi-bin/tmi/friendly.pl method=post>\n";
print "<input type=hidden name=method value=\"suche\">\n";


print "&nbsp;&nbsp;<input type=text name=suche style=\"font-family=verdana;font-size=10px\" value=\"$such\" maxlength=25>\n";
...
if ( $hit > 100 ) {
print "&nbsp; Ihr Suchbegriff '$such' ergab mehr als 100 Treffer ...<br>&nbsp; Bitte konkrtisieren Sie Ihren Begriff ...<br>\n";
goto jo;
...
print "<form name=g$x action=/cgi-mod/tmi/verein.pl method=post>\n";
...
print "<td align=left bgcolor=#cbccff><font face=verdana size=1>&nbsp;&nbsp;<a href=javascript:document.g$x.submit()><img src=/img/h1.jpg border=0 alt=\"Vereinsseite $data[$hit_nr[$x]]\"></a>&nbsp;&nbsp;$teil1<font color=red>$1<font color=black>$teil2&nbsp;&nbsp;&nbsp;</td>\n";



} else {
print "<td align=left bgcolor=#cbccff><font face=verdana size=1>&nbsp;&nbsp;<a href=javascript:document.g$x.submit()><img src=/img/h1.jpg border=0 alt=\"Vereinsseite $data[$hit_nr[$x]]\"></a>&nbsp;&nbsp;$data[$hit_nr[$x]]&nbsp;&nbsp;&nbsp;</td>\n";
}
...
close (D2);
print "<td align=left bgcolor=#CCCDF4><font face=verdana size=1>&nbsp;&nbsp;$liga_namen[$liga[$hit_nr[$x]]]&nbsp;&nbsp;&nbsp;&nbsp;</td>\n";
print "<td align=right bgcolor=#CCCDF4><font face=verdana size=1>&nbsp;&nbsp;$platz. Platz&nbsp;&nbsp;&nbsp;</td>\n";


print "<form name=h$x action=/cgi-mod/tmi/trainer.pl method=post>\n";
...
print "<td align=left bgcolor=white><font face=verdana size=1>&nbsp;&nbsp;<a href=javascript:document.h$x.submit()><img src=/img/h1.jpg border=0 alt=\"Trainerprofil $datb[$hit_nr[$x]]\"></a>&nbsp;&nbsp;<img src=/img/$flag>&nbsp;&nbsp;$teil1<font color=red>$1<font color=black>$teil2&nbsp;&nbsp;&nbsp;</td>\n";



} else {
print "<td align=left bgcolor=white><font face=verdana size=1>&nbsp;&nbsp;<a href=javascript:document.h$x.submit()><img src=/img/h1.jpg border=0 alt=\"Trainerprofil $datb[$hit_nr[$x]]\"></a>&nbsp;&nbsp;<img src=/img/$flag>&nbsp;&nbsp;$datb[$hit_nr[$x]]&nbsp;&nbsp;&nbsp;</td>\n";
}
...
print "<form name=i$x action=/cgi-bin/tmi/friendly.pl method=post>\n";
...
print "<td align=left bgcolor=white><font face=verdana size=1>&nbsp;&nbsp;<a href=javascript:document.i$x.submit()>zum Freundschaftsspiel einladen</a>&nbsp;&nbsp;</td>\n";
} else {
print "<td align=left bgcolor=white><font face=verdana size=1>&nbsp;&nbsp;Freundschaftsspiel nicht moeglich&nbsp;&nbsp;</td>\n";
}
print "</form>\n";
...
close (D2);
require "/tmapp/tmsrc/cgi-bin/runde.pl";
print "<br><font size=2><font color=darkred><b> &nbsp; ~ Eingegangene Freundschaftspiel Angebote dieser Tiprunde: </b><font color=black><br><br>\n";

open (D1,"</tmdata/tmi/friendly/friendly.txt");
while (<D1>) {
@all = split (/#/,$_) ;
if ( $all[3] eq $team ) {
if ( $all[1] == $rrunde ) {
...
print "<form name=tip$all[0] action=/cgi-bin/tmi/friendly.pl method=post>\n";
...
if ( $all[1] == $rrunde ) {
print "[ Tiprunde $all[1] ] &nbsp; $all[2] ( $liga_kuerzel[$r2{$all[2]}] / $r1{$all[2]}. ) - $all[3] ( $liga_kuerzel[$r2{$all[3]}] / $r1{$all[3]}. ) [ -> <a href=javascript:document.tip$all[0].submit()>Zur Tipabgabe</a> ]<br>";
}
...
print "[ Tiprunde $all[1] ] &nbsp; $all[2] ( $liga_kuerzel[$r2{$all[2]}] / $r1{$all[2]}. ) - $all[3] ( $liga_kuerzel[$r2{$all[3]}] / $r1{$all[3]}. ) [ -> Tip getaetigt ]<br>";
}

else {
print "[ Tiprunde $all[1] ] &nbsp; $all[2] ( $liga_kuerzel[$r2{$all[2]}] / $r1{$all[2]}. ) - $all[3] ( $liga_kuerzel[$r2{$all[3]}] / $r1{$all[3]}. )<br>";
...
print "<br><font size=2><font color=darkred><b> &nbsp; ~ Rausgeschickte Freundschaftspiel Angebote dieser Tiprunde: </b><br><br><font color=black>\n";
...
print "[ Tiprunde $all[1] ] &nbsp; $all[2] ( $liga_kuerzel[$r2{$all[2]}] / $r1{$all[2]}. ) - $all[3] ( $liga_kuerzel[$r2{$all[3]}] / $r1{$all[3]}. )  [ -> Tip steht noch aus ]<br>";
} else {
print "[ Tiprunde $all[1] ] &nbsp; $all[2] ( $liga_kuerzel[$r2{$all[2]}] / $r1{$all[2]}. ) - $all[3] ( $liga_kuerzel[$r2{$all[3]}] / $r1{$all[3]}. )  [ -> Tip getaetigt ]<br>";
}
...
print "<td bgcolor=#eeeeee><font size=1>&nbsp;</td><td bgcolor=#eeeeee><font face=verdana size=1>&nbsp;1&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;0&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2</td><td bgcolor=black><SPACER TYPE=BLOCK WIDTH=1 HEIGHT=1></td></tr><tr>\n";
for ($x=1 ; $x <=16 ; $x++ ){print "<td bgcolor=black><SPACER TYPE=BLOCK WIDTH=1 HEIGHT=1></td>\n"}
...
if ( $flagge[$x] < 3 ){
print "<td align=left bgcolor=$farbe>&nbsp;&nbsp;&nbsp;&nbsp;<font face=verdana size=1><img src=/img/$flag border=0 width=14 height=10>&nbsp;&nbsp;&nbsp;<a href=javascript:document.xr$x.submit()>$paarung[$x]</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>\n";

}elsif  (( $flagge[$x] == 3 ) or ( $flagge[$x] == 5 )or ( $flagge[$x] == 4 )or ( $flagge[$x] == 8 )){
print "<td align=left bgcolor=$farbe>&nbsp;&nbsp;&nbsp;&nbsp;<font face=verdana size=1><img src=/img/$flag width=14 height=10 border=0>&nbsp;&nbsp;&nbsp;<a href=javascript:document.xr$x.submit()>$paarung[$x]</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>\n";
...
print "<font face=verdana size=2><br><br>\n";
print "&nbsp;<b>Fehlermeldung - Freundschaftsspiel Tipabgabe</b><br><br>&nbsp;<font color=darkred><b>$heim - $gegner</b><font color=black>\n";
print "<font size=1><br>\n";
print "<br>\n";

print "<br><br><font face=verdana size=2 color=darkred> &nbsp; <b>Sie haben keinen Tip abgegeben ; dies ist bei einem Freundschaftsspiel nicht zul�ssig !<br><br> &nbsp; Bitte kehren Sie zur Tipabgabe zurueck und korregieren Sie Ihren Tip !\n";
exit;
}
...
print "<br><br><font face=verdana size=2 color=darkred> &nbsp; <b>Sie haben mehr als 5 Tips abgegeben ( ihre Tipanzahl $tips ) ; dies ist bei einem Freundschaftsspiel nicht zul�ssig !<br><br> &nbsp; Bitte kehren Sie zur Tipabgabe zurueck und reduzieren Sie Ihre Tipanzahl !\n";
exit;
}
...
print "<br><br><font face=verdana size=2 color=darkred> &nbsp; <b>Sie haben weniger als 5 Tips abgegeben ( ihre Tipanzahl $tips ) ; dies ist bei einem Freundschaftsspiel nicht zul�ssig !<br><br> &nbsp; Bitte kehren Sie zur Tipabgabe zurueck und reduzieren Sie Ihre Tipanzahl !\n";
exit;
}
...
print "<font face=verdana size=2><br><br>\n";
print "&nbsp;<b>Fehlermeldung - Freundschaftsspiel</b><br><br>&nbsp;<font color=darkred><b>$heim - $gegner</b><font color=black>\n";
print "<font size=1><br>\n";
print "<br>\n";

print "<br><br><font face=verdana size=2 color=black>Es existiert fuer diese Tiprunde bereits ein Freundschaftsspiel Angebot<br>fuer den Verein $gegner .<br><br>Pro Tiprunde ist nur ein Freundschaftsspiel gegen einen Verein moeglich !\n";
exit;
...
$at=0;
read1:
open (D1,"/tmdata/tmi/friendly/nummer.txt");
$nummer = <D1>;
chomp $nummer ;
close (D1);
if ( $nummer < 1000 && $at < 10 ) { $at++; goto read1; }
...
print "<font face=verdana size=2><br><br>\n";
print "&nbsp;<b>Freundschaftsspiel Tipabgabe</b><br><br>&nbsp;<font color=darkred><b>$heim - $gegner</b><font color=black>\n";
print "<font size=1><br>\n";
print "<br>\n";

print "<br><font face=verdana size=2 color=black>\n";
print "Ihr Freundschaftsspiel Angebot wurde registriert .<br>Nur wenn Ihr Gegner seine Tipabgabe fuer das Freundschaftsspiel<br>bis Freitag 18.oo Uhr taetigt wird das Spiel ausgetragen .<br><br>Ihre Tipabgabe wurde registriert und kann nicht mehr modifiziert werden .\n";
print "<br><br>Sie haben nun die M�glichkeit den Trainer $gegner_n von $gegner<br>eine Message zu schreiben so dass er von Ihrem Freundschaftsspiel Angebot Notiz nimmt :<br><br>\n";
...
print "<td bgcolor=#F3C6F4 align=right>&nbsp;&nbsp;<font face=verdana size=1>Absender :&nbsp;&nbsp;</td><td align=left bgcolor=#d9daff><font face=verdana size=1>&nbsp;&nbsp;$trainer&nbsp;&nbsp;( $heim )&nbsp;&nbsp;</td></tr>\n";
print "<td bgcolor=#F3C6F4 align=right>&nbsp;&nbsp;<font face=verdana size=1>Empf�nger :&nbsp;&nbsp;</td><td align=left bgcolor=#d9daff><font face=verdana size=1>&nbsp;&nbsp;$gegner_n&nbsp;&nbsp;( $gegner )&nbsp;&nbsp;</td></tr>\n";
...
print "<td bgcolor=#F3C6F4 align=right>&nbsp;&nbsp;<font face=verdana size=1>Betreff :&nbsp;&nbsp;</td><td align=left bgcolor=#d9daff><font face=verdana size=1>&nbsp;&nbsp;<input style=\"font-family=verdana;font-size=10px\" type=text name=subject size=45 maxlength=35 value=\"Spiel - $heim\">&nbsp;&nbsp;</td></tr>\n";
print "<tr><td bgcolor=#F3C6F4 valign=top align=right>&nbsp;&nbsp;<font face=verdana size=1>Nachricht :&nbsp;&nbsp;</td></td><td align=left bgcolor=#d9daff><font face=verdana size=1>\n";
print "\n";

print "&nbsp;&nbsp;<textarea style=\"font-family=verdana;font-size=10px;\" name=text rows=8 cols=90 maxrows=8 maxcols=90 wrap=virtual>Sehr geehrte(r) $gegner_n ,\n\nder Trainer $trainer von $heim hat Sie fuer die\naktuelle Tiprunde zu einem Freundschaftsspiel eingeladen.\n\nWenn Sie Interesse haben zu diesem Freundschaftsspiel anzutreten\ntaetigen Sie bitte fristgerecht bis Freitag 18.oo Uhr Ihre Tipabgabe\nunter dem Link Freundschaftsspiele in Ihrem LogIn Bereich .</textarea><br>\n";
print "<br>&nbsp;&nbsp;<input type=submit value=\"Nachricht senden\"><br></td></tr></table></td></tr></table></form>\n";
...
print "<br><font face=verdana size=2 color=black>\n";
print "Ihre Tipabgabe wurde registriert und damit wird das Freundschaftsspiel <br>an diesem Wochenende ausgetragen !<br><br>Ihre Tipabgabe kann nicht mehr modifiziert werden .\n";
...
print "      targetWin = open(URL,\"Neufenster\",\"scrollbars=yes,toolbar=no,directories=no,menubar=no,status=no,resizeable=yes,width=850,height=280\");\n";
print " }\n";
print "  //-->\n";
print "  </script>\n";
...
print "<form name=ok action=/cgi-bin/tmi/friendly.pl method=post>\n";
print "<input type=hidden name=method value=\"\">\n";


print "&nbsp;<a href=javascript:document.ok.submit()>Eigenes Freundschaftsspiel austragen / Tipabgabe Freundschaftsspiel</a><br><br>\n";
print "</form>\n";
...
print "<form method=post action=/cgi-bin/tmi/friendly.pl target=_top>\n";
print "<font face=verdana size=1>";
print "<input type=hidden name=method value=liste>\n";

print "&nbsp;<font face=verdana size=2><b>TipMaster international Freundschaftsspiele&nbsp;&nbsp;\n";
...
print "<font face=verdana size=2><b>( $spiel Spiele )</b> &nbsp; &nbsp; <input type=submit value=\"Spiele laden\" style=\"font-family: Verdana; font-size: 11px; font-weight: normal; color: #000000;\"></form>";
print "<form method=post action=/cgi-bin/tmi/friendly.pl target=_top>\n";
...
print "<input type=text style=\"font-family: Verdana; font-size: 11px; font-weight: normal; color: #000000;\" name=verein_suche>";
print "&nbsp; &nbsp; <input type=submit value=\"Suche starten\" style=\"font-family: Verdana; font-size: 11px; font-weight: normal; color: #000000;\"></form>";
print "</form>";
#print "$suche_ja $verein_suche";
...
print "&nbsp; <a href=/cgi-bin/tmi/friendly.pl?huni=$hu&method=liste&akt_runde=$akt_runde>";
print "Spiel $xx bis $xy</a> &nbsp; ";
$li=1;
}
...
#print "$los $verein_suche $all[2] $coach{$all[2]}<br>";
...
print  "<TD align=left width=260><font face=verdana color=$color1 size=2> &nbsp; <b>$all[2]</b><br><font size=1 color=black> &nbsp; &nbsp;$coach{$all[2]} ( $liga_kuerzel[$r2{$all[2]}] / $r1{$all[2]}. Platz )</td>\n";
#print  "<td class=ce width=90> ( $liga_kuerzel[$r2{$all[2]}] / $r1{$all[2]}. ) -</TD>\n";
#print  "<td class=ce width=30>-</td>\n";
print  "<TD align=left width=260><font face=verdana color=$color2 size=2> &nbsp; <b>$all[3]</b><br><font size=1 color=black> &nbsp; &nbsp;$coach{$all[3]} ( $liga_kuerzel[$r2{$all[3]}] / $r1{$all[3]}. Platz )</td>\n";
#print  "<td class=ce width=90>( $liga_kuerzel[$r2{$all[3]}] / $r1{$all[3]}. ) </TD>\n";

$su_1=0;$sp=0;$su_2=0;$tora=0;$torb=0;
@spiele = split (/,/,$all[4]);
for ($c=1;$c<=5;$c++){
$xx=($c-1)*2;
$xy=($xx+1);;
...
for ( $xx = 1; $xx <= 5; $xx++ ) {
if ( ($pro1[$xx] == 1) and ( $ergebnis[$sp1[$xx]] == 1 ) ) { $su_1 = $su_1 + $qu_1[$sp1[$xx]] }
if ( ($pro1[$xx] == 2) and ( $ergebnis[$sp1[$xx]] == 2 ) ) { $su_1 = $su_1 + $qu_0[$sp1[$xx]] }
if ( ($pro1[$xx] == 3) and ( $ergebnis[$sp1[$xx]] == 3 ) ) { $su_1 = $su_1 + $qu_2[$sp1[$xx]] }
...
for ( $xx = 1; $xx <= 5; $xx++ ) {
if ( ($pro1[$xx] == 1) and ( $ergebnis[$sp1[$xx]] == 1 ) ) { $su_2 = $su_2 + $qu_1[$sp1[$xx]] }
if ( ($pro1[$xx] == 2) and ( $ergebnis[$sp1[$xx]] == 2 ) ) { $su_2 = $su_2 + $qu_0[$sp1[$xx]] }
if ( ($pro1[$xx] == 3) and ( $ergebnis[$sp1[$xx]] == 3 ) ) { $su_2 = $su_2 + $qu_2[$sp1[$xx]] }
...
print  "<TD align=center width=60><font face=verdana size=2 color=$cett><b> $tora <font color=black>:<FONT color=$cett> $torb </FONT></TD>\n";
}
...
print  "<TD ALIGN=RIGHT><a href=tips_fr.pl?ru=$all[1]&line1=$all[4]&line2=$all[5]&ve1=$ra1&ve2=$ra2 target\"_blank\" onClick=\"targetLink('tips_fr.pl?ru=$all[1]&line1=$all[4]&line2=$all[5]&ve1=$ra1&ve2=$ra2');return false\"><IMG SRC=/img/ti.jpg BORDER=0 alt=\"Detail - Tipansicht\"></A>&nbsp;</TD>\n";
