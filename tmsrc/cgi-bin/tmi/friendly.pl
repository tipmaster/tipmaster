...
print
"<font size=1> &nbsp; <a href=/cgi-bin/tmi/friendly.pl?method=liste>Bereits fixe Freundschaftsspiele diese Woche</a><br><br>\n";
...
"<td bgcolor=#eeeeee><font size=1>&nbsp;</td><td bgcolor=#eeeeee><font face=verdana size=1>&nbsp;1&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;0&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2</td><td bgcolor=black><SPACER TYPE=BLOCK WIDTH=1 HEIGHT=1></td></tr><tr>\n";
	...
	for ( $x = 1 ; $x <= 25 ; $x++ ) {
		...
		if ( $flagge[$x] < 3 ) {
			print
"<td align=left bgcolor=$farbe>&nbsp;&nbsp;&nbsp;&nbsp;<font face=verdana size=1><img src=/img/$flag border=0 width=14 height=10>&nbsp;&nbsp;&nbsp;<a href=javascript:document.xr$x.submit()>$paarung[$x]</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>\n";
...
"&nbsp;<a href=javascript:document.ok.submit()>Eigenes Freundschaftsspiel austragen / Tipabgabe Freundschaftsspiel</a><br><br>\n";
	...
	print
"<font face=verdana size=2><b>( $spiel Spiele )</b> &nbsp; &nbsp; <input type=submit value=\"Spiele laden\" style=\"font-family: Verdana; font-size: 11px; font-weight: normal; color: #000000;\"></form>";
	print "<form method=post action=/cgi-bin/tmi/friendly.pl target=_top>\n";
