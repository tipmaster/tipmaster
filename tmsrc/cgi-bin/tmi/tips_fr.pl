...
print "</font></td>\n";
print "<td align=left valign=middle width=250><font face=verdana size=1><img src=/img/loch.JPG border=0><br><font color=black>\n";
for ( $x = 1; $x < 6;$x++ ) {
...
print "&nbsp;&nbsp;&nbsp;&nbsp;<img src=http://www.tipmaster.de/img/$flag width=14 height=10 border=0>&nbsp;&nbsp;&nbsp;&nbsp;<a href=javascript:document.xs$x.submit()>$paarung[$sp2[$x]]</a><br>\n";
