...
my $session;
if ( $method eq "show" ) {
	$session = TMSession::getSession();
}
else {
	$session = TMSession::getSession( tmi_login => 1 );
}
...
if ( $method eq "show" ) {
	...
	if ( $einsicht == 1 ) {
		...
		while (<D1>) {
			...
			$tips_land{$rr} .=
"$xc $goof[0]  $goof[2]  $goof[3] [ # $nr{$goof[3]} | $datum{$goof[3]} $zeit{$goof[3]}] Quote $goof[4]  [ $goof[5] ] </font><br>\n";
			$tips_landos{$rr} .=
"$goof[5]!$xc $goof[0]  $goof[2]  $goof[3] [ # $nr{$goof[3]} | $datum{$goof[3]} $zeit{$goof[3]}] Quote $goof[4]  [ $goof[5] ] </font><br>";
		}
		close(D1);
		...
		for ( $x = 1 ; $x <= $tx ; $x++ ) {
			...
			print
"<a name=$x><br><font face=verdana size=2 color=darkred><b>[#$x] Tipabgaben Nationalmannschaft $land :</b> &nbsp; &nbsp; &nbsp; <font size=1>[ <a href=#0>back to top</a> ]\n";
...
if ( $method eq "save" ) {
	...
	$tips = 0;
	print
"<font face=verdana size=1>Bei Problemen mit der Tipabgabe die Fehlermeldung inkl.<br>der folgenden Zeile an info\@tipmaster.net mailen !<br>";
	...
	if ( $tips > 3 ) {
		...
		print
"<html><body bgcolor=white text=black link=blue vlink=blue><title>Tipabgabe Nationalmannschaft $coach fuer $land</title>";
		print "<p align=left>\n";

		#require "/tmapp/tmsrc/cgi-bin/tag.pl" ;
		#require "/tmapp/tmsrc/cgi-bin/tag_small.pl" ;
		print
"<br><br><font face=verdana size=2 color=darkred> &nbsp; <b>Sie haben mehr als 3 Tips abgegeben ( ihre Tipanzahl $tips ) ; dies ist bei der Nationalmannschaft Tipabgabe nicht zulaessig !<br><br> &nbsp; Bitte kehren Sie zur Tipabgabe zurueck und reduzieren Sie Ihre Tipanzahl !\n";
		exit;
	}
...
"<html><body bgcolor=white text=black link=blue vlink=blue><title>Tipabgabe Nationalmannschaft $coach fuer $land</title>";
		...
		#require "/tmapp/tmsrc/cgi-bin/tag_small.pl" ;
		print
"<br><br><font face=verdana size=2 color=darkred> &nbsp; <b>Sie haben keinen Tip abgegeben ; dies ist bei der Nationalmannschaft Tipabgabe nicht zulaessig !<br><br> &nbsp; Bitte kehren Sie zur Tipabgabe zurueck und korregieren Sie Ihren Tip !\n";
		exit;
	}
...
"<html><body bgcolor=white text=black link=blue vlink=blue><title>Tipabgabe Nationalmannschaft $coach fuer $land</title>";
	...
	print
"<br><br><font face=verdana size=2 color=darkred> &nbsp; <b>Von Ihnen wurden folgende NM - Tips fuer Ihr Land $land registriert :</b><br><br>\n";
  ...
  read1:
	...
	for ( $d = 1 ; $d <= $tips ; $d++ ) {
		print
"<font color=black><b> &nbsp; &nbsp; &nbsp; * &nbsp; &nbsp; Tip $quote[$d] $paarung[$merk[$d]] Quote $quotex[$d] &nbsp; &nbsp; ( $mest[$d] )</b></font><br>";
	...
	print
" &nbsp; &nbsp;<font face=verdana size=2> &nbsp;Bitte beachten : Wenn Sie vor diesem Tip in dieser Tiprunde bereits einen Tip fuer<br>\n";
	print " &nbsp; &nbsp; die Nationalmannschaft abgegeben haben , wurde dieser durch diese Tipabgabe ersetzt !\n";

	print
	  "<br><br><font color=black face=verdana> &nbsp; &nbsp; <i>Sie werden zur LogIn Seite weiter geleitet ...</i>\n";
...
sub homepages {
	...
	print
"Die URLs koennen vom Praesidenten und Teamchef des jeweiligen Landes<br>ueber die Kaderverwaltung eingetragen/modifiziert werden<br><br><p align=left>";
	...
	for ( $goof = 1 ; $goof <= $rr_ligen ; $goof++ ) {
		...
		if ( $kk{$rr} != 1 ) {
			...
			if ( $all[3] ne "Fehlanzeige" ) {
				print
" &nbsp; &nbsp; &nbsp; &nbsp; $rr &nbsp;&nbsp; <img src=$a1> &nbsp;</td><td align=left><font face=verdana size=1>&nbsp;<a href=$all[3] target=new>$all[3]</a></td></tr>\n";
			}
			else {
				print
" &nbsp; &nbsp; &nbsp; &nbsp; $rr &nbsp;&nbsp; <img src=$a1> &nbsp;</td><td align=left><font face=verdana size=1>&nbsp;
$all[3]</td></tr>\n";
			}
...
"<html><body bgcolor=white text=black link=blue vlink=blue><title>Tipabgabe Nationalmannschaft $coach fuer $land</title>";
	...
	print
"<br>Neben dem Ligabetrieb haben sich beim TipMaster international auf freiwilliger Basis Nationalmannschaften gegruendet<br>\n";
	print
"die nach dem TipMaster Modus gegeneinander Freundschaftsspiele austragen und nun auch eine Europameisterschaft veranstalten .<br>";
	print
"<br>Wenn du auch fuer Nationalmannschaft deines Landes tippen moechtest besuche die NM - Kaderverwaltung und wende dich an\n";
	print
"<br>den Teamchef oder den Praesidenten deines Landes. Falls fuer dein Land noch keine Nationalmannschaft existiert nimm<br>das Heft einfach selbst in die Hand und versuche mit den Trainerkollegen deiner Liga eine zu gruenden !\n";
	print
"<br><br>Aktuelle Infos zu den Nationalmannschaften findet hier auch im <a href=http://community.tipmaster.de target=new>Nationalmannschafts Forum</a>.<br><br>";
	print "<form name=back action=/cgi-bin/tmi/nm_edit.pl method=post></form>\n";
	print
"<font face=verdana size=1>[ -> <a href=javascript:document.back.submit()>Nationalmannschafts Kaderverwaltung / Aufstellungen</a> ]<br>\n";
...
Zu den Nationalmannschafts-Ligen</a> ]<br><br>";
 ...
 &nbsp; <img src=/img/new.gif><br><br>";
	...
	if ( $einsicht == 1 ) {
		...
		print
"<br>[ -> <a href=/cgi-bin/tmi/tipabgabe_ls.pl?method=show>Einsicht in die Nationalmannschafts Tipabgaben dieser Woche</a> ]<br><br>";
...
#print "<font face=verdana size=1><br>\n";
	...
	print
"<br><font face=verdana size=2 color=darkred><b>Achtung : Falls die Tipabgabe nicht klappt bitte die Tipabgabe<br>mit einer anderen Browsersoftware/version versuchen !</b><br>";
...
"<img src=/img/spacer2.gif></td><td><img src=/img/spacer4.gif><td></td><td><img src=/img/spacer3.gif></td></td></tr><tr>\n";
	...
	print
"<td bgcolor=#eeeeee><font face=verdana size=1>&nbsp;</td><td bgcolor=#eeeeee><font face=verdana size=1>&nbsp;&nbsp;&nbsp;&nbsp;Quoten</td><td bgcolor=black><SPACER TYPE=BLOCK WIDTH=1 HEIGHT=1></td><td bgcolor=#eeeeee align=center><font face=verdana size=1>Gegner</td>\n";
...
"<td bgcolor=#eeeeee>&nbsp;</td><td bgcolor=#eeeeee><font face=verdana size=1>&nbsp;1&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;0&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2\n";
	print
"</td><td bgcolor=black><SPACER TYPE=BLOCK WIDTH=1 HEIGHT=1></td><td bgcolor=#eeeeee><font face=verdana size=1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td bgcolor=black><SPACER TYPE=BLOCK WIDTH=1 HEIGHT=1></td></tr><tr>\n";
	for ( $x = 1 ; $x <= 11 ; $x++ ) { print "<td bgcolor=black><SPACER TYPE=BLOCK WIDTH=1 HEIGHT=1></td>\n" }
	...
	for ( $x = 1 ; $x <= 25 ; $x++ ) {
		...
		if ( $flagge[$x] < 3 ) {
			print
"<td align=left bgcolor=$farbe>&nbsp;&nbsp;&nbsp;&nbsp;<font face=verdana size=1><img src=/img/$flag HEIGHT=10 WIDTH=14 border=0>&nbsp;&nbsp;&nbsp;$paarung[$x]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>\n";
...
"<td align=left bgcolor=$farbe>&nbsp;&nbsp;&nbsp;&nbsp;<font face=verdana size=1><img src=/img/$flag HEIGHT=10 WIDTH=14 border=0>&nbsp;&nbsp;&nbsp;$paarung[$x]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>\n";
			...
			print
"<td align=left bgcolor=$farbe>&nbsp;&nbsp;&nbsp;&nbsp;<font face=verdana size=1><a href=$url target=new><img HEIGHT=10 WIDTH=14 src=/img/$flag border=0></a>&nbsp;&nbsp;&nbsp;$paarung[$x]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>\n";
		}
...
"<td bgcolor=$farbe><font face=verdana size=1> $qu_1[$x] &nbsp;&nbsp; $qu_0[$x] &nbsp;&nbsp; $qu_2[$x] &nbsp;&nbsp;</td>\n";
		...
		print
"<select style=\"font-family:verdana;font-size:10px;\" name=m$tipo[$x]><option value=\"Keine Auswahl\" selected>Gegner NM waehlen ...\n";
