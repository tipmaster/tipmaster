...
$wechsel++;
($leer,$wechsel0[$wechsel],$wechsel1[$wechsel],$wechsel2[$wechsel],$wechsel3[$wechsel],$wechsel5[$wechsel],$wechsel4[$wechsel]) = split (/&/ , $_);
...
print "<br><font face=verdana size=2>&nbsp;<b>Die letzten 50 vollzogenen Vereinswechsel :</b><br><br>\n";
...
for ($x=$wechsel ; $x>=($wechsel-50) ; $x-- ) {

print "<tr>";


print "<td align=left bgcolor=#eeeeff><font face=verdana size=1>&nbsp;&nbsp;$wechsel0[$x]&nbsp;&nbsp;</td> \n";
print "<td align=left bgcolor=#eeeeff><font face=verdana size=1>&nbsp; <img src=/img/h1.jpg> &nbsp;$wechsel2[$x]&nbsp;&nbsp; </td> \n";
...
@wechsel4=();
@wechsel5=();
open(D2,"/tmdata/tmi/tausch_liste.txt");
while(<D2>) {

$wechsel++;
($leer,$wechsel0[$wechsel],$wechsel1[$wechsel],$wechsel2[$wechsel],$wechsel3[$wechsel],$wechsel5[$wechsel],$wechsel4[$wechsel]) =
split (/&/ , $_);


}
close (D2);
print "<font face=verdana size=2>&nbsp;<b>Die letzten 50 vollzogenen Vereinstaeusche :</b><br><br>\n";
print "<table border=0 cellpadding=0 cellspacing=0 bgcolor=black>\n";
print "<tr><td>\n";
print "<table border=0 cellpadding=1 cellspacing=1>\n";
