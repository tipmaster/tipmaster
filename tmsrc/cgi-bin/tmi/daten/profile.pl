...
<html>
<head>
<title>TipMaster international : Trainer - Profil aendern</title>
</head>
...
<form action=/cgi-bin/tmi/daten/profil_data.pl  method=post target=_top>
...
Ihre Hobbys :<br>( Hobbys bitte durch Kommatas trennen )<br>
...
<input type="checkbox" name="notifier" value="formular" $notifiercheck>Info-Mail
, wenn Formular online geht</input><br>
