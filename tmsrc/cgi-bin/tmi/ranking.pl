...
print "<form method=post action=/cgi-bin/tmi/ranking.pl target=_top>\n";
print "<font face=verdana size=1>";
...
if ( $me == 7 ) { $gh = "selected" }
print "<option value=7 $gh>Die offensivst�rksten Trainer ( Tore pro Spiel ) \n";
...
print "&nbsp;&nbsp<input type=hidden name=id value=\"$id\"><input type=submit style=\"font-family: Verdana; font-size: 11px; font-weight: normal; color: #000000;\" value=\"Tabelle laden\"></form><br>";
...
$aa=$trainer[$ident[$t]];
$aa=~s/ /%20/g ;
print "<td bgcolor=#eeeeff align=left><font face=verdana size=1 color=$color>&nbsp;&nbsp;<img src=/img/$ima>&nbsp;&nbsp;&nbsp;<a href=/cgi-mod/tmi/trainer.pl?ident=$aa><img src=/img/h1.jpg border=0 alt=\"Trainerstatistik $trainer[$ident[$t]]\"></a>&nbsp;&nbsp;$trainer[$ident[$t]]&nbsp;&nbsp;</td>\n";
$color="black" ;
$aa=$verein{$trainer[$ident[$t]]};
$aa=~s/ /%20/g ;

print "<td bgcolor=#f5f5ff align=left><font face=verdana size=1 color=$color>&nbsp;&nbsp;<a href=/cgi-mod/tmi/verein.pl?ident=$aa><img src=/img/h1.jpg border=0 alt=\"Vereinsstatistik $verein{$trainer[$ident[$t]]}\"></a>&nbsp;&nbsp;$verein{$trainer[$ident[$t]]}&nbsp;&nbsp;</td>\n";



print "<td class=ve bgcolor=#f5f5ff align=left><font color=$color>&nbsp;&nbsp;$liga_kuerzel[$liga{$trainer[$ident[$t]]}]&nbsp;&nbsp;</td>\n";
...
print "<td bgcolor=#eeeeff align=left><font face=verdana size=1 color=$color>&nbsp;&nbsp;<img src=/img/$ima>&nbsp;&nbsp;&nbsp;<a href=/cgi-mod/tmi/trainer.pl?ident=$aa><img src=/img/h1.jpg border=0 alt=\"Trainerstatistik $coach[$ident[$t]]\"></a>&nbsp;&nbsp;$coach[$ident[$t]]&nbsp;&nbsp;</td>\n";
$color="black" ;

$aa=$verein{$coach[$ident[$t]]};
$aa=~s/ /%20/g ;
print "<td bgcolor=#f5f5ff align=left><font face=verdana size=1 color=$color>&nbsp;&nbsp;<a href=/cgi-mod/tmi/verein.pl?ident=$aa><img src=/img/h1.jpg border=0 alt=\"Vereinsstatistik $verein{$coach[$ident[$t]]}\"></a>&nbsp;&nbsp;$verein{$coach[$ident[$t]]}&nbsp;&nbsp;</td>\n";



print "<td class=ve bgcolor=#f5f5ff align=left><font color=$color>&nbsp;&nbsp;$liga_kuerzel[$liga{$coach[$ident[$t]]}]&nbsp;&nbsp;</td>\n";
...
open(D2,"/tmdata/tmi/stat$me.txt");
while(<D2>) {
$rr++;
($trainer[$rr],$rest) = split (/&/,$_);
...
open(D2,"/tmdata/tmi/stat5.txt");
while(<D2>) {
$rr++;
($trainer[$rr],$rest) = split (/&/,$_);
($rest,$spiele[$rr],$spiele_mi[$rr],$qp_g[$rr],  $qm_g[$rr] , $qp_mi[$ti] ,  $qu5{$trainer[$rr]}, $qu6{$trainer[$rr]}, $qu7{$trainer[$rr]},$qu8{$trainer[$rr]},$qu9{$trainer[$rr]}) = split (/&/,$_);
}
close (D2) ;
...
$qpd[$dd] = 0;
$coach[$ti] = $trainer[$ti] ;
#print "<br>$bewerber_verein_basis{$verein{$coach[$ti]}}\n";

if ( $bewerber_verein_basis{$verein{$coach[$ti]}} == 1 ) { $fa = 300 - (($bewerber_verein_platz{$verein{$coach[$ti]}}-1)*3)}
if ( $bewerber_verein_basis{$verein{$coach[$ti]}} == 2 ) { $fa = 270 - (($bewerber_verein_platz{$verein{$coach[$ti]}}-1)*3)}
if ( $bewerber_verein_basis{$verein{$coach[$ti]}} == 3 ) { $fa = 240 - (($bewerber_verein_platz{$verein{$coach[$ti]}}-1)*3)}
if ( $bewerber_verein_basis{$verein{$coach[$ti]}} == 4 ) { $fa = 210 - (($bewerber_verein_platz{$verein{$coach[$ti]}}-1)*3)}
if ( $bewerber_verein_basis{$verein{$coach[$ti]}} == 5 ) { $fa = 180 - (($bewerber_verein_platz{$verein{$coach[$ti]}}-1)*3)}
if ( $bewerber_verein_basis{$verein{$coach[$ti]}} == 6 ) { $fa = 150 - (($bewerber_verein_platz{$verein{$coach[$ti]}}-1)*3)}
if ( $bewerber_verein_basis{$verein{$coach[$ti]}} == 7 ) { $fa = 120 - (($bewerber_verein_platz{$verein{$coach[$ti]}}-1)*3)}
if ( $bewerber_verein_basis{$verein{$coach[$ti]}} == 8 ) { $fa =  90 - (($bewerber_verein_platz{$verein{$coach[$ti]}}-1)*3)}
if ( $bewerber_verein_basis{$verein{$coach[$ti]}} == 9 ) { $fa =  60 - (($bewerber_verein_platz{$verein{$coach[$ti]}}-1)*3)}
...
if ( $qu7{$trainer[$ti]} ne "----" ) {
if  ( $qu7{$trainer[$ti]} > 0)  { $qpd[$dd] = int ( $qpd[$dd] + ($qu7{$trainer[$ti]}-0)) }
}
...
if ( $pp[$ti] < 10 ) { $pp[$ti] = '0' . $pp[$ti] }
if ( $pp[$ti] < 100 ) { $pp[$ti] = '0' . $pp[$ti] }
$quoten[$ti] = $pp[$ti] ; 
$quoten[$ti] = $quoten[$ti] . '#' ;
...
print "<td bgcolor=#eeeeff align=right><font face=verdana size=1>&nbsp;$qu7{$coach[$ident[$t]]}&nbsp;</td>\n";
