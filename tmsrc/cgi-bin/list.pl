...
if ( $id == 1 ) {
	print
"<font size=1 face=tahoma,verdana>Zur Aufnahme Ihrer Seite senden Sie bitte eine E-Mail an info\@tipmaster.de<br><br>[ <a href=http://www.tipmaster.de/cgi-bin/tmi/tipabgabe_ls.pl?method=hps>Liste aller Nationalmannschafts Homepages</a> ]<br><br><br>";
}
