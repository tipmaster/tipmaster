...
$c=int($c/60);
$xx++;
if ($c <0){ print "$all[1] zu lange keine Refresh ...\n"}
#if ( $2c >0 ) {
if ($c>-128000){
...
$frei++;$auswahl_verein[$frei] = $data[$x] ;
$auswahl_liga[$frei] = $liga ;}
$y++;chomp $verein[$y];$datc[$x] = $vereine[$y];}}}
$frei=$frei*1;
...
################# CHECK BTM UND TMI #########################
$vorhanden_para=0;$vorhanden_btm=0;$vorhanden_tmi=0;$vorhanden = 0;$r = 0;$mail_vorhanden = 0;
