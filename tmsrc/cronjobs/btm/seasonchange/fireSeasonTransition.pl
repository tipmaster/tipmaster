...
`rm /tmdata/btm/tipos/*.*`;
`rm /tmdata/btm/tips/1/*`;print "Sp.1 geloescht ...\n";
`rm /tmdata/btm/tips/5/*`;print "Sp.5 geloescht ...\n";
`rm /tmdata/btm/tips/9/*`;print "Sp.9 geloescht ...\n";
`rm /tmdata/btm/tips/13/*`;print "Sp.13 geloescht ...\n";
`rm /tmdata/btm/tips/17/*`;print "Sp.17 geloescht ...\n";
`rm /tmdata/btm/tips/21/*`;print "Sp.21 geloescht ...\n";
`rm /tmdata/btm/tips/25/*`;print "Sp.25 geloescht ...\n";
`rm /tmdata/btm/tips/29/*`;print "Sp.29 geloescht ...\n";
`rm /tmdata/btm/tips/33/*`;print "Sp.33 geloescht ...\n";
`rm -r /tmdata/btm/pokal/tips/`;print "Loesche Pokaltips ...\n";
`rm /tmdata/btm/pokal/pokal_qu[1-7].txt`;print "Loesche Pokalquoten ...\n";
...
open (D1,">/tmdata/btm/tip_datum.txt");print D1 "1";close(D1);
