	...
	for ( $saison = $a1 ; $saison <= $a2 ; $saison++ ) {
		...
		for ( $x = 1 ; $x <= 49 ; $x++ ) {
			...
			if ( $all[1] > $all[2] ) {
				...
				print D5
"$saison&$yy&$team[$bb1[1]]&$trainer{$team[$bb1[1]]}&$team[$bb1[2]]&$trainer{$team[$bb1[2]]}&$all[1]&$all[2]&\n";
			}
			else {
				...
				print D5
"$saison&$yy&$team[$bb1[2]]&$trainer{$team[$bb1[2]]}&$team[$bb1[1]]&$trainer{$team[$bb1[1]]}&$all[2]&$all[1]&\n";
			}
