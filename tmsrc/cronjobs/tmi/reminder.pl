...
Ihre Tipabgabe unter http://www.tipmaster.de/tmi/ zu taetigen .
...
(END ERROR HTML)
  ...
  print MAIL "From: noreply\@tipmaster.de\n";
    print MAIL "Subject: Trainer Entlassung droht / Tip - Reminder [TMI] $datq[$x] \n" ;
...
Registrierung beim TipMaster vorgenommen haben schreiben
Sie bitte eine kurze Mail an info\@tipmaster.net mit der Bitte
zur L�schung des mit Ihrer E-Mail Adresse angelegten Accounts .
**************************************************************************
(END ERROR HTML)
