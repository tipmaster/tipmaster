...
$datei_data = '/tmdata/tmi/' . $hg . $anton . $liga . $beta ;
...
if ( $liga_namen[$liga] =~/Amateurklasse/ ) { $hohe = 4}
if ( $liga_namen[$liga] =~/Amateurliga/ ) { $hohe = 3}
if ( $liga_namen[$liga] =~/2\.Liga/ ) { $hohe =2}
if ( $liga_namen[$liga] =~/1\.Liga/ ) { $hohe =1 }
