...
print
"<title>Tipabgabe $data[$ros1] - $data[$ros2]</title><body bgcolor=#eeeeee text=black vlink=blue link=blue><font face=verdana size=1><center>\n";
...
print "</font></td>\n";
print
"<td align=left width=250 valign=middle nowrap=nowrap><font face=verdana size=1><img src=/img/loch.JPG border=0><br><font color=black>\n";
for ( $x = 1 ; $x < 6 ; $x++ ) {
...
print "</font></td>\n";
print
"<td nowrap=nowrap align=left valign=middle width=250><font face=verdana size=1><img src=/img/loch.JPG border=0><br><font color=black>\n";
for ( $x = 1 ; $x < 6 ; $x++ ) {
