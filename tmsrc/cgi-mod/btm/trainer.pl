...
my $xa="";my $i=0;my $x="";my $query; my $liga; my $verein;
...
$suche = '&' . $coach . '&' ;
my $tmi_verein = "no";my $tmi_liga=0;
$li=0;
...
$t++;
($nummer , $ve ) = split (/&/ , $_);
($nummer , $ve , $li1[$nummer] , $li2[$nummer] , $li3[$nummer] , $li4[$nummer] , $li5[$nummer] , $li6[$nummer] , $li7[$nummer] , $li8[$nummer] ,  $li9[$nummer] ,  $li10[$nummer] ) = split (/&/ , $_);
chomp $li9[$nummer] ;
chomp $ve ;
$team[$nummer] = $ve ;
}
...
print "<br> &nbsp;&nbsp;&nbsp;&nbsp;-> zu den <a href=/cgi-bin/btm/award.pl target=new>Trainer - Award Rankings</a><br><br>";
...
print " &nbsp;&nbsp;&nbsp;&nbsp;$seson[$gop[1]+5] : Wahl zum Trainer - Fuxx der Saison&nbsp; &nbsp; &nbsp; <br>";
}
...
if ( $trainer eq $coach ) {
print "<form name=pr action=/cgi-bin/btm/daten/profile.pl method=post><input type=hidden name=address value=\"$coach\">\n";
...
$aa=~s/ /%20/g;
print "<td class=f colspan=5> <a href=/cgi-mod/btm/verein.pl?ident=$aa><img src=/img/h1.jpg border=0 alt=\"Vereinsseite $team[$station_verein[$x]]\"></a> &nbsp; $team[$station_verein[$x]] </td>\n";
...
print "</table>\n";
print "</td></tr></table>\n";
print "<font face=verdana size=1 color=darkred><br>&nbsp;Die Vereinsplazierung geben die Saisonendplazierung wieder und<br>&nbsp;nicht die Vereinsplazierung zum Zeitpunkt des Wechsels .<font color=black>\n";
...
print "<form name=ad action=/cgi-bin/btm/mail/mailbox.pl method=post><input type=hidden name=method value=\"add_adress\">\n";
