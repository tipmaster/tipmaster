...
my $spielrunde_ersatz; my $ein; my $wert; my $ein_a;
...
my $tmp1=$saison-1;my $tmp2=$saison+1;
...
print "</select>&nbsp <a href=tab.pl?saison=$tmp2&li=$liga target=_top><img src=/img/h1.jpg border=0></a>&nbsp; &nbsp; \n";
...
print "&nbsp;&nbsp;&nbsp;<input type=hidden name=trainer value=\"$leut\"><input type=hidden name=id value=\"$id\" ><input type=hidden name=ligi value=\"$ligi\" ><input type=submit  style=\"font-family: Verdana; font-size: 11px; font-weight: normal; color: #000000; \"  value=\"Tabelle laden\"></form>";
...
print "<TD class=l><a href=/cgi-mod/btm/verein.pl?saison=$saison&ident=$tmp><img src=/img/h1.jpg heigth=10 width=10 alt=\"Vereinsseite $data[$tab[$yx]]\" border=0></a> &nbsp; <font color=$color>$data[$tab[$yx]]</TD>\n";
...
print "<TR bgcolor=white><TD colspan=2></TD><TD class=d> &nbsp;&nbsp; Serie</TD><TD class=d>Sp.</TD><TD colspan=3 class=d> &nbsp;
