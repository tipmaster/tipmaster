...
while (<DO>) {
	...
	( $nummer, $ve ) = split( /&/, $_ );
	(
		$nummer,       $ve,           $li1[$nummer], $li2[$nummer], $li3[$nummer],
		$li4[$nummer], $li5[$nummer], $li6[$nummer], $li7[$nummer], $li8[$nummer]
	) = split( /&/, $_ );
	chomp $ve;
	$team[$nummer] = $ve;
...
if ( $btm_liga != 0 ) {
	...
	print "<tr><td align=right bgcolor=#eeeeff><font face=verdana size=1>Liga &nbsp; </td>\n";
	print
"<td align=left bgcolor=white><font face=verdana size=1>&nbsp;&nbsp;&nbsp;&nbsp;$liga_namen_btm[$btm_liga]</td></tr>\n";
}
...
if ( ( $wohnort ne "keine Angabe" ) and ( $wohnort ne "" ) ) {
	...
	print
"<td align=left bgcolor=white><font face=verdana size=1>&nbsp;&nbsp;&nbsp;&nbsp;$wohnort&nbsp;&nbsp;&nbsp;</td></tr>\n";
}
if ( ( $bundesland ne "keine Angabe" ) and ( $bundesland ne "" ) and ( $bundesland ne "01.01.1900" ) ) {
	...
	print
"<td align=left bgcolor=white><font face=verdana size=1>&nbsp;&nbsp;&nbsp;&nbsp;$bundesland&nbsp;&nbsp;&nbsp;</td></tr>\n";
}
if ( ( $land ne "keine Angabe" ) and ( $land ne "" ) ) {
	print "<tr><td align=right bgcolor=#eeeeff><font face=verdana size=1>&nbsp;&nbsp;&nbsp;Land &nbsp; </td>\n";
	print
"<td align=left bgcolor=white><font face=verdana size=1>&nbsp;&nbsp;&nbsp;&nbsp;$land&nbsp;&nbsp;&nbsp;</td></tr>\n";
}
if ( ( $geburtstag ne "01.01.1900" ) and ( $geburtstag ne "" ) and ( $geburtstag ne "keine Angabe" ) ) {
	...
	print
"<td align=left bgcolor=white><font face=verdana size=1>&nbsp;&nbsp;&nbsp;&nbsp;$geburtstag&nbsp;&nbsp;&nbsp;</td></tr>\n";
}
if ( ( $beruf ne "keine Angabe" ) and ( $beruf ne "" ) and ( $beruf ne "kein Angabe" ) ) {
	...
	print
"<td align=left bgcolor=white><font face=verdana size=1>&nbsp;&nbsp;&nbsp;&nbsp;$beruf&nbsp;&nbsp;&nbsp;</td></tr>\n";
}
if ( ( $liebling ne "keine Angabe" ) and ( $liebling ne "" ) ) {
	print
	  "<tr><td align=right bgcolor=#eeeeff><font face=verdana size=1>&nbsp;&nbsp;&nbsp;Lieblingsverein &nbsp; </td>\n";
	print
"<td align=left bgcolor=white><font face=verdana size=1>&nbsp;&nbsp;&nbsp;&nbsp;$liebling&nbsp;&nbsp;&nbsp;</td></tr>\n";
}
if ( ( $hobby ne "keine Angabe" ) and ( $hobby ne "" ) ) {
	print "<tr><td align=right bgcolor=#eeeeff><font face=verdana size=1>&nbsp;&nbsp;&nbsp;Hobbys &nbsp; </td>\n";
	print
"<td align=left bgcolor=white><font face=verdana size=1>&nbsp;&nbsp;&nbsp;&nbsp;$hobby&nbsp;&nbsp;&nbsp;</td></tr>\n";
}
if ( ( $motto ne "keine Angabe" ) and ( $motto ne "" ) ) {
	print
	  "<tr><td align=right bgcolor=#eeeeff><font face=verdana size=1>&nbsp;&nbsp;&nbsp;Statement zum TMI &nbsp;</td>\n";
	print
"<td align=left bgcolor=white><font face=verdana size=1>&nbsp;&nbsp;&nbsp;&nbsp;$motto&nbsp;&nbsp;&nbsp;</td></tr>";
}
...
"<tr><td align=right bgcolor=#eeeeff valign=top><br><font face=verdana size=1>&nbsp;&nbsp;&nbsp;Trainer Awards &nbsp; </td>\n";
	...
	print
"<br> &nbsp;&nbsp;&nbsp;&nbsp;-> zu den <a href=http://www.tipmaster.de/cgi-bin/tmi/award.pl target=new>Trainer - Award Rankings</a><br><br>";
...
"<tr><td align=right bgcolor=#eeeeff valign=top><font face=verdana size=1>&nbsp;&nbsp;&nbsp;Auszeichnungen &nbsp; </td>\n";
	...
	for ( $x = 1 ; $x <= $award ; $x++ ) {
		...
		print
		  " &nbsp;&nbsp;&nbsp;&nbsp;$seson[$gop[1]+4] : Wahl zum Trainer - Fuxx der Saison&nbsp; &nbsp; &nbsp; <br>";
	}
...
if ( $trainer eq $coach ) {
	print
"<form name=pr action=http://www.tipmaster.de/cgi-bin/tmi/daten/profile.pl method=post><input type=hidden name=trainer value=\"$trainer\"><input type=hidden name=address value=\"$coach\">\n";
	print
...
"<tr><td align=left valign=top colspan=2><br><br>&nbsp;<font face=verdana size=2><b>Bisherige Trainerstationen $coach</b><br><br>\n";
	...
	for ( $x = 1 ; $x <= $station ; $x++ ) {
		...
		if ( $team[ $station_verein[$x] ] ne "" ) {
			...
			$aa =~ s/ /%20/g;
			print
"<td class=f colspan=5> <a href=/cgi-mod/tmi/verein.pl?ident=$aa><img src=/img/h1.jpg border=0 alt=\"Vereinsseite $team[$station_verein[$x]]\"></a> &nbsp; $team[$station_verein[$x]] </td>\n";
			...
			if ( ( $station_saison[$x] > 9 ) and ( $station_saison[$x] < 12 ) ) {
				$sai[ $station_saison[$x] ] = $old2new[ $sai[ $station_saison[$x] ] ];
			}
	...
	print "</td></tr></table>\n";
	print
"<font face=verdana size=1 color=darkred><br>&nbsp;Die Vereinsplazierung geben die Saisonendplazierung wieder und<br>&nbsp;nicht die Vereinsplazierung zum Zeitpunkt des Wechsels .<br>&nbsp;In der Saison 2000'2 wurden keine Spiele beim TMI ausgetragen .<font color=black>\n";
...
"<td align=left bgcolor=#eeeeff><font face=verdana size=1>&nbsp;&nbsp;<input type=submit value=\"Nachricht senden\">&nbsp;&nbsp;</td>\n";
	...
	print "</form>\n";
	print
"<form name=ad action=/cgi-bin/tmi/mail/mailbox.pl method=post><input type=hidden name=method value=\"add_adress\">\n";
