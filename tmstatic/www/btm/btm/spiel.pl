...
my $mlib="";my $aaff=0;
my $fff=0;my $color1="";my $color2=""; my $ausw="";my %ver="";my @cookies =();
...
my @tip1 = ();my @tip2 = ();my @pro1 = ();my @sp1 = ();my $torc=0;my $tord=0;
...
my $sp02 = "";my $sp03 = "";my $fa = "";my $rkl = "";my @max = (); my @max1 = ();
...
print "</select>&nbsp;&nbsp;\n";
print "&nbsp;&nbsp;<input type=hidden name=live value=$live><input type=hidden name=ligi value=\"$ligi\"><input type=hidden name=id value=\"$id\"><iNPUT TYPE=SUBMIT style=\"font-family: Verdana; font-size: 11px; font-weight: normal; \" VALUE=\"Resultate laden\"></form>\n";
...
print "<form name=vor method=post action=/cgi-mod/btm/spiel.pl target=_top><input type=hidden name=id value=\"$id\"><input type=hidden name=ligi value=\"$ligi\"><input type=hidden name=sp value=\"$sp01\"><input type=hidden name=li value=\"$liga\"><input type=hidden name=live value=$live></form>\n";
print "<form name=hinter method=post action=/cgi-mod/btm/spiel.pl target=_top><input type=hidden name=id value=\"$id\"><input type=hidden name=ligi value=\"$ligi\"><input type=hidden name=sp value=\"$sp02\"><input type=hidden name=li value=\"$liga\"><input type=hidden name=live value=$live></form>\n";
print "<form name=live method=post action=/cgi-mod/btm/spiel.pl target=_top><input type=hidden name=id value=\"$id\"><input type=hidden name=ligi value=\"$ligi\"><input type=hidden name=sp value=\"$sp03\"><input type=hidden name=li value=\"$liga\"><input type=hidden name=live value=0></form>\n";
print "<form name=nolive method=post action=/cgi-mod/btm/spiel.pl target=_top><input type=hidden name=id value=\"$id\"><input type=hidden name=ligi value=\"$ligi\"><input type=hidden name=sp value=\"$sp03\"><input type=hidden name=li value=\"$liga\"><input type=hidden name=live value=1></form>\n";
...
print "</b><br><font face=verdana size=2>&nbsp;&nbsp;<b>Resultate $liga_namen[$liga]</b>&nbsp;&nbsp;/&nbsp;&nbsp;<a href=javascript:document.hinter.submit()><img src=/img/h2.jpg heigth=10 width=10  alt=\"$sp02.Spieltag\" border=0></a>&nbsp;&nbsp;$spielrunde.Spieltag&nbsp;&nbsp;<a href=javascript:document.vor.submit()><img src=/img/h1.jpg heigth=10 width=10  alt=\"$sp01.Spieltag\" border=0></a>\n";

if ( $spielrunde_ersatz > $spielrunde_live ) {
if ( ( $spielrunde <= ($spielrunde_live + 4) ) and ( $spielrunde > $spielrunde_live ) ) {

if ( $live == 1 )  { print "&nbsp;&nbsp;&nbsp;&nbsp;<b><a href=javascript:document.live.submit()>Livetabelle anzeigen</a></b><font size=1> ( mit Zwischenergebnissen )"; }
if ( $live == 0 )  { print "&nbsp;&nbsp;&nbsp;&nbsp;<b><a href=javascript:document.nolive.submit()>Reale Tabelle anzeigen</a></b><font size=1> ( ohne Zwischenergebnisse )"; }
...
open (D,"</tmdata/btm_ausw.txt");$ausw=<D>;chomp $ausw;close(D);
$ausw*=1;
print "<br><font face=verdana size=1>&nbsp;&nbsp;Verfolgen Sie die realen Zwischenergebnisse 
der europaieschen Top - Ligen mit unserem 
<a href=http://www.fussball-liveticker.eu target=new1>-> Live - Ergebnisdienst !</a><br>\n";
...
$color = "black";
if ( ($data[$ega[$x]] eq $session->getBTMTeam() ) ) { $color="red" }

print  "<TR BGCOLOR=$farbe>\n";
my $spacer=" &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ";
if ( $x != 0 ) { $spacer="" }

print  "<TD class=le><font color=$color><a href=verein.pl?ve=$ega[$x]&li=$liga><img src=/img/h1.jpg heigth=10 width=10  alt=\"Vereinsseite $data[$ega[$x]]\" border=0></a> &nbsp; $data[$ega[$x]]</td>\n";
...
if ( ($data[$ega[$y]] eq $session->getBTMTeam()) )  { $color="red" }

print  "<TD class=le><font color=$color><a href=verein.pl?ve=$ega[$y]&li=$liga><img src=/img/h1.jpg heigth=10 width=10  alt=\"Vereinsseite $data[$ega[$y]]\" border=0></a> &nbsp; $data[$ega[$y]] </td></form>\n";
...
print  "<TD class=ce2><font color=$cett><font color=$color1>$tora <font color=black>:<FONT color=$color2> $torb </FONT></TD>\n";
}
...
if ( ( $tab[$x] > 14 ) and ( $liga > 1 && $liga < 129) ) { $kuerzel = " [N]" }
if ( ( $tab[$x] == 1 ) and ( $liga == 1 ) ) { $kuerzel = " [M]" }
if ( ( $tab[$x] < 4 ) and ( $liga == 2 ) ) { $kuerzel = " [A]" }
if ( ( $tab[$x] > 15 ) and ( $liga == 1 || ($liga > 128 && $liga < 257)) ) { $kuerzel = " [N]" }
...
print "<TD class=le><a href=verein.pl?ve=$tab[$x]&li=$liga><img src=/img/h1.jpg heigth=10 width=10  alt=\"Vereinsseite $data[$tab[$x]]\" border=0></a> &nbsp; <FONT color=$color>$data[$tab[$x]]</TD>\n";
...
print "<TD class=le> &nbsp; <a href=trainer.pl?ve=$tab[$x]&li=$liga><img src=/img/h1.jpg heigth=10 width=10  alt=\"Trainerprofil $datb[$tab[$x]]\" border=0></a> &nbsp; $datb[$tab[$x]]</TD>\n";
} else {
print "<TD class=le> &nbsp; <img src=/img/h1.jpg heigth=10 width=10  alt=\"Trainerposten nicht besetzt\" border=0> &nbsp; $datb[$tab[$x]]</TD>\n";
