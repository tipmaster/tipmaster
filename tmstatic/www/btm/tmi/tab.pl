...
my @uef=();my $status="";my $saison="";my $spielrunde_ersatz; my $ein; my $wert; my $ein_a;
my $ein_b; my $spieltag; my $x; my $suche; my $gg;
my $ro; my $rf; my $rx; my @vereine; my $gp;my $dd="";
my $y; my @verein; my @data; my @datb; my @datc;
my @ego; my $hg; my $anton; my $beta; my $datei_data;
my @quoten_row; my $gh; my $fa; my $fc;
my @ega; my @quoten_zahl; my $tora; my $torb; my $wa;
my $wb; my @dat_sp; my @dat_hsp; my @dat_asp; my @dat_qu;
my @dat_gqu; my @dat_hqu; my @dat_ghqu; my @dat_aqu; my @dat_gaqu;
my @dat_tp; my @dat_tm; my @dat_htp; my @dat_htm; my @dat_atp;
my @dat_atm; my $lr; my $ls; my $ll; my @dat_hi;
my @dat_gs; my @dat_hs; my @dat_gpu; my @dat_gn; my @dat_an;
my @dat_as; my @dat_hn; my @dat_gu; my @dat_hu; my @dat_au;
my @plx; my @tab; my $xy; my @dat_td; my @dat_htd;
my @dat_atd; my @dat_hpu; my @dat_apu; my $v; my $e;
my @dat_qu_m; my @dat_gqu_m; my @dat_hqu_m; my @dat_ghqu_m; my @dat_aqu_m;
my @dat_gaqu_m; my $xx; my $yx; my @pl1; my $farbe;
my $ce_1; my $ce_2; my $ce_3; my $ce_4; my $ce_5;
my $color;  my $t; my $r; my @merk;
my $query;  my $liga;
my $ligi; my $id; my $live; my $spielrunde; my $methode;
my $sp_ende; my $sp_start; my $leer;
my $rr_ligen; my $kuerzel; my $ok; my @liga_art;
my @liga_kuerzel; my %pokal; my $kat; my @liga_kat; my @line_1;
my @line_2; my @line_3; my @line_4; my $kata;
...
print "TD.r { text-align:right;padding-top:3px;padding-bottom:3px;padding-left:5px;padding-right:10px;font-family:Verdana; font-size:8pt; color:black; alignment: right; }\n";
print "TD.r1 { padding-left:5px;padding-right:0px;font-family:Verdana; font-size:8pt; color:black; text-align:right; }\n";
print "TD.r2 { padding-left:10px;padding-right:22px;font-family:Verdana; font-size:8pt; color:black; text-align:right; }\n";
print "TD.c { padding-left:10px;padding-right:10px;font-family:Verdana; font-size:8pt; color:black; text-align:center; }\n";
print "TD.l { padding-left:10px;padding-right:10px;font-family:Verdana; font-size:8pt; color:black; alignment: left; }\n";
print "TD.d { text-align:middle;padding-bottom:8px; padding-left:10px;padding-right:10px;font-family:Verdana; font-size:8pt; color:black;  }\n";
print "</style>\n";
print "</head>\n";
...
print "Sp.&nbsp;<input type=text  style=\"font-family: Verdana; font-size: 11px; font-weight: normal; color: #000000; background-color: #FFFFFF;\" size=2 maxlenght=2 value=$sp_start name=start>&nbsp;bis&nbsp;<input type=text  style=\"font-family: Verdana; font-size: 11px; font-weight: normal; color: #000000; background-color: #FFFFFF;\" size=2 maxlenght=2 value=$sp_ende name=ende>&nbsp;&nbsp;";
print "&nbsp;&nbsp;&nbsp;<input type=hidden name=trainer value=\"$leut\"><input type=hidden name=id value=\"$id\" ><input type=hidden name=ligi value=\"$ligi\" ><input  style=\"font-family: Verdana; font-size: 11px; font-weight: normal; color: #000000;\" type=submit value=\"Tabelle laden\"></form>";
...
print "<TR bgcolor=white><TD colspan=2></TD><TD class=d> &nbsp;&nbsp; Serie</TD><TD class=d>Sp.</TD><TD colspan=3 class=d> &nbsp; &nbsp; Bilanz</TD><TD></TD><TD class=d>Tore</TD>
...
my @uefa=("SPA I", "GER I", "MAL I", "NIR I", "SLO I", "NOR I", "ISR I", "LUX I", "ALB I", "FRA I", "SLK I" );
...
my $tmp = $data[$tab[$yx]];$tmp=~s/ /%20/g;
print "<TD class=l><a href=/cgi-mod/tmi/verein.pl?saison=$saison&ident=$tmp><img src=/img/h1.jpg heigth=10 width=10 alt=\"Vereinsseite $data[$tab[$yx]]\" border=0></a> &nbsp; <font color=$color>$data[$tab[$yx]]</TD>\n";
...
my $tmp=$datb[$tab[$yx]];$tmp=~s/ /%20/g;
print "<TD class=l><a href=trainer.pl?ident=$tmp><img src=/img/h1.jpg heigth=10 width=10  alt=\"Trainerprofil $datb[$tab[$yx]]\" border=0></a> &nbsp; $datb[$tab[$yx]]</TD>\n";
} 
else {
...
$kata = $liga ;
if ( ($kata == 2 ) or ($kata == 4 ) or ($kata == 6 ) or ($kata == 8 ) or ($kata == 10 ) or ($kata == 12 ) or ($kata == 14 ) or ($kata == 16 ) or ($kata == 18 ) or ($kata == 20 ) or ($kata == 22 ) ) { 
$ein = 0 ;
if ( $x == 3 ) { $ein = 1 }
}
