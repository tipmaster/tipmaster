...
my @uef=();my $live_id="";my $fff=0;my $color1=""; my $color2=""; my $ausw="";my %ver="";my @cookies =();
my $query = "";my $liga = "";my $ligi = "";my $id = "";my $live = "";my $spielrunde = "";my $spielrunde_ersatz = "";my $spielrunde_live = "";
my $ein = "";my $x = "";my $ro = "";my $suche = "";my $bv = "";my $txt = "";my $datei_quoten = "";my $lok = "";my $fgh = "";my $rf = "";
my $rx = "";my $gg = "";my @vereine = ();my $gp = "";my $y = "";my @verein = ();my @data = ();my @datb = ();my @datc = ();my @ego = ();
my $hg = "";my $anton = "";my $beta = "";my $datei_data = "";my @quoten_row = ();my $va = "";my $vab = "";my $ex = "";my $lo = "";my $bx = "";
my $by = "";my $datei_hier = "";my @vareine = ();my @ega = ();my @paarung = ();my @qu_1 = ();my @qu_0 = ();my @qu_2 = ();my @ergebnis = ();my $rtz = "";
my $datei_quoten3 = "";my @tips = ();my $la = "";my $lb = "";my $lc = "";my @vx = ();my $c = "";my $paar = "";my $row1 = "";my $row2 = "";
my @tip1 = ();my @tip2 = ();my @pro1 = ();my @sp1 = ();my @liga_art=();
my @pro2 = ();my @sp2 = ();my $su_1 = "";my $su_2 = "";my $end = "";my @summe = ();my $kk = "";my $spieltag = "";my @quoten_zahl = ();my $tora = "";my $torb = "";
my $wa = "";my $wb = "";my @dat_sp = ();my @dat_hsp = ();my @dat_asp = ();my @dat_qu = ();my @dat_gqu = ();my @dat_hqu = ();my @dat_ghqu = ();my @dat_aqu = ();
my @dat_gaqu = ();my @dat_tp = ();my @dat_tm = ();my @dat_htp = ();my @dat_htm = ();my @dat_atp = ();my @dat_atm = ();my @dat_gs = ();my @dat_hs = ();my @dat_gpu = ();
my @dat_gn = ();my @dat_an = ();my @dat_as = ();my @dat_hn = ();my @dat_gu = ();my @dat_hu = ();my @dat_au = ();my @pl = ();my @tab = ();my @dat_td = ();
my @dat_htd = ();my @dat_atd = ();my @dat_hpu = ();my @dat_apu = ();my @plx = ();my $nn = "";my $ve = "";my @liga_namen = ();my $gh = "";my $sp01 = "";
my $sp02 = "";my $sp03 = "";my $fa = "";my $rkl = "";
my $rrr = "";my $farbe = "";my $xx = "";my $start = "";my $color = "";my $mar = "";my $cett = "";my $ya = "";
my $yb = "";my $bild = "";my @end = ();my $ra1 = "";my $ra2 = "";my $v = "";my $e = "";my @dat_qu_m = ();my @dat_gqu_m = ();
my @dat_hqu_m = ();my @dat_ghqu_m = ();my @dat_aqu_m = ();my @dat_gaqu_m = ();my $kuerzel = "";my $ima = "";
my $rr_liga=0;my $games=0;
my @liga_kat = ();my $ok = "";my $kat = "";my @kat1 = ();my @kat2 = ();my @kat3 = ();my @kat4 = ();my @kat5 = ();my @line = ();my $kata = "";
my %pokal="";my @liga_kuerzel=();my @max1=();my $torc=0;my $tord=0;my @max=();
...
@liga_namen = ( "spacer" , "Italien Serie A" , "Italien Serie B" , "Italien Amateurliga A" , "Italien Amateurliga B" , "Italien Amateurklasse A" , "Italien Amateurklasse B" , "Italien Amateurklasse C" , "Italien Amateurklasse D" ,
...
my @liga_kuerzel = ( "---" , "ITA I" , "ITA II" , "ITA III/A" , "ITA III/B" , "ITA IV/A" , "ITA IV/B"  , "ITA IV/C" , "ITA IV/D" ,
...
print "TD.ri { padding-left:5px;padding-right:10px;font-family:Verdana; font-size:8pt; color:black; alignment: right; }\n";
print "TD.ce { padding-left:8px;padding-right:8px;font-family:Verdana; font-size:8pt; color:black; font-align: center;}\n";
print "TD.ce2 { padding-left:28px;padding-right:28px;font-family:Verdana; font-size:8pt; color:black; font-align: center;}\n";
print "TD.bl { font-family:Verdana; font-size:8pt;}\n";
print "TD.le { padding-left:5px;padding-right:10px;font-family:Verdana; font-size:8pt; color:black; alignment: left;}\n";
...
print "TD.ri2 { padding-left:10px;padding-right:1px;font-family:Verdana; font-size:8pt; color:black; alignment: right; }\n";
...
print "</select>&nbsp;&nbsp;\n";
print "&nbsp;&nbsp;<input type=hidden name=live value=$live><input type=hidden name=ligi value=\"$ligi\"><input type=hidden name=id value=\"$id\"><iNPUT TYPE=SUBMIT   style=\"font-family: Verdana; font-size: 11px; font-weight: normal; color: #000000;\" VALUE=\"Resultate laden\"></form>\n";
...
print "<form name=vor method=post action=/cgi-mod/tmi/spiel.pl target=_top><input type=hidden name=id value=\"$id\"><input type=hidden name=ligi value=\"$ligi\"><input type=hidden name=sp value=\"$sp01\"><input type=hidden name=li value=\"$liga\"><input type=hidden name=live value=$live></form>\n";
print "<form name=hinter method=post action=/cgi-mod/tmi/spiel.pl target=_top><input type=hidden name=id value=\"$id\"><input type=hidden name=ligi value=\"$ligi\"><input type=hidden name=sp value=\"$sp02\"><input type=hidden name=li value=\"$liga\"><input type=hidden name=live value=$live></form>\n";
print "<form name=live method=post action=/cgi-mod/tmi/spiel.pl target=_top><input type=hidden name=id value=\"$id\"><input type=hidden name=ligi value=\"$ligi\"><input type=hidden name=sp value=\"$sp03\"><input type=hidden name=li value=\"$liga\"><input type=hidden name=live value=0></form>\n";
print "<form name=nolive method=post action=/cgi-mod/tmi/spiel.pl target=_top><input type=hidden name=id value=\"$id\"><input type=hidden name=ligi value=\"$ligi\"><input type=hidden name=sp value=\"$sp03\"><input type=hidden name=li value=\"$liga\"><input type=hidden name=live value=1></form>\n";
...
print "</b><font face=verdana size=2>&nbsp;<img src=$a1 border=0>&nbsp; <b>Resultate $liga_namen[$liga] ( Kat $liga_kat[$liga] )</b>&nbsp;&nbsp;/&nbsp;&nbsp;<a href=javascript:document.hinter.submit()><img src=/img/h2.jpg alt=\"$sp02. Spieltag\" border=0></a>&nbsp;&nbsp;$spielrunde. Spieltag&nbsp;&nbsp;<a href=javascript:document.vor.submit()><img src=/img/h1.jpg  alt=\"$sp01. Spieltag\" border=0></a>\n";

if ( $spielrunde_ersatz > $spielrunde_live ) {
if ( ( $spielrunde <= ($spielrunde_live + 4) ) and ( $spielrunde > $spielrunde_live ) ) {

if ( $live == 1 )  { print "&nbsp;&nbsp;&nbsp;&nbsp;<b><a href=javascript:document.live.submit()>Livetabelle anzeigen</a></b><font size=1>"; }
if ( $live == 0 )  { print "&nbsp;&nbsp;&nbsp;&nbsp;<b><a href=javascript:document.nolive.submit()>Reale Tabelle anzeigen</a></b><font size=1>"; }
...
if ( ( $spielrunde <= ($spielrunde_live + 4) ) and ( $spielrunde > $spielrunde_live ) ) {
print "<br>\n";
open (D,"</tmdata/tmi_ausw.txt");$ausw=<D>;chomp $ausw;close(D);$ausw=$ausw*1;
$ausw*=1;
...
if ( ($pro2[$x] == 2) and ( $ergebnis[$sp2[$x]] == 4 ) ) { $su_2 = $su_2 + 10 }
if ( ($pro2[$x] == 3) and ( $ergebnis[$sp2[$x]] == 4 ) ) { $su_2 = $su_2 + 10 }
if ( ($pro2[$x] == 1) and ( $ergebnis[$sp2[$x]] == 0 ) ) { $max[$c+1] = $max[$c+1] + $qu_1[$sp2[$x]]  }
if ( ($pro2[$x] == 2) and ( $ergebnis[$sp2[$x]] == 0 ) ) { $max[$c+1] = $max[$c+1] + $qu_0[$sp2[$x]]  }
if ( ($pro2[$x] == 3) and ( $ergebnis[$sp2[$x]] == 0 ) ) { $max[$c+1] = $max[$c+1] + $qu_2[$sp2[$x]]  }
...
print  "<TD class=le><font color=$color><a href=verein.pl?ve=$ega[$x]&li=$liga><img src=/img/h1.jpg  alt=\"Vereinsseite $data[$ega[$x]]\" border=0></a> &nbsp; $data[$ega[$x]]</td>\n";
...
print  "<TD class=le><font color=$color><a href=verein.pl?ve=$ega[$y]&li=$liga><img src=/img/h1.jpg alt=\"Vereinsseite $data[$ega[$y]]\" border=0></a> &nbsp; $data[$ega[$y]] </td></form>\n";
...
print  "<TD class=ce2><font color=$cett><font color=$color1>$tora <font color=black>:<FONT color=$color2> $torb </TD>\n";
...
my @uefa=("","AND I", "SPA I", "GER I", "MAZ I", "FRA I", "MAL I", "POR I", "CRO I", "ITA I", "BIL I", "ALB I" );
...
print "<TD class=le><a href=verein.pl?ve=$tab[$x]&li=$liga><img src=/img/h1.jpg alt=\"Vereinsseite $data[$tab[$x]]\" border=0></a> &nbsp; <FONT color=$color>$data[$tab[$x]]</TD>\n";
...
print "<TD class=le> &nbsp; <a href=trainer.pl?ve=$tab[$x]&li=$liga><img src=/img/h1.jpg alt=\"Trainerprofil $datb[$tab[$x]]\" border=0></a> &nbsp; $datb[$tab[$x]]</TD>\n";
} else {
print "<TD class=le> &nbsp; <img src=/img/h1.jpg alt=\"Trainerposten nicht besetzt\" border=0> &nbsp; $datb[$tab[$x]]</TD>\n";
