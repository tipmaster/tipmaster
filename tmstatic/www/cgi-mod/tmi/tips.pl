...
my $coc="";my $query = "";my $liga = "";my $ligi = "";my $id = "";my $live = "";my $spielrunde = "";my $spielrunde_ersatz = "";my $spielrunde_live = "";
...
my @tip1 = ();my @tip2 = ();my @pro1 = ();my @sp1 = ();
...
my $verein1 = "";my $verein2 = "";my $fs = "";my $fars = "";my $jo = "";my @iaa = ();my @iab = ();my $ros1 = "";my $ros2 = "";my @flagge = ();my $r = "";
my $flag = "";my $url = "";my $vv = "";



my @main_flags = ( "uefa.gif" , "tip_ger.gif" , "tip_ger.gif" , "tip_eng.gif" , "tip_fra.gif" , "tip_ita.gif" , "tip_swi.gif" ,
"tip_aut.gif" , "tip_spa.gif" , "tip_no.gif" ,
"tip_swe.gif" , "tip_nor.gif" , "tip_fin.gif" , "tip_den.gif" , "tip_ned.gif" , "tip_sco.gif" , "flag_wm.gif" , "tip_ger.gif","tip_rus.gif","tip_por.gif","tip_irl.gif");
...
print "<html><title>Tipabgabe $verein1 - $verein2</title><body bgcolor=#eeeeee text=black vlink=blue link=blue><font face=verdana size=1><center>\n";
...
if ( $pro1[1] == 0 ) {
print "<center><br><font face=verdana size=2><b>Die beiden Tipabgaben fuer dieses Spiel sind noch<br>nicht erfolgt bzw. noch nicht zur Einsicht freigegeben.<br><br><font color=darkred> Die Tipabgaben der aktuellen Spielrunde sind<br>ab Freitags 18.oo Uhr hier einsehbar.</b><br><br>";
print "<form name=d1 action=/cgi-bin/tmi/form.pl method=post target=new>\n";
print "</form>\n";
print "<br><br><font face=verdana size=1><a href=javascript:document.d1.submit()>Anstosszeiten der Paarungen des aktuellen Tipformulars</a></b>\n";
...
print "</font></td>\n";
print "<td align=left valign=middle width=250 nowrap=nowrap><font face=verdana size=1><img src=/img/loch.JPG border=0><br>\n";
for ( $x = 1; $x < 6;$x++ ) {
...
print "&nbsp;&nbsp;&nbsp;&nbsp;<img width=14 height=10 src=/img/$flag border=0>&nbsp;&nbsp;&nbsp;&nbsp;$paarung[$sp1[$x]]<br>\n";
...
print "<form target=new_live method=post target=new name=xr$x><input type=hidden name=verein1 value=\"$verein1\"><input type=hidden name=index value=\"$vv\"><input type=hidden name=verein2 value=\"$verein2\"></form>\n";
}

print "</td>\n";
print "<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td nowrap=nowrap align=left valign=top><font face=verdana size=1><img src=/img/loch.JPG><br>\n";
...
print "</font></td>\n";
print "<td align=left valign=middle width=250 nowrap=nowrap><font face=verdana size=1><img src=/img/loch.JPG border=0><br><font color=black>\n";
for ( $x = 1; $x < 6;$x++ ) {
...
print "&nbsp;&nbsp;&nbsp;&nbsp;<img width=14 height=10 src=/img/$flag border=0>&nbsp;&nbsp;&nbsp;&nbsp;$paarung[$sp2[$x]]<br>\n";
...
print "<form target=new_live  method=post target=new name=xs$x><input type=hidden name=verein1 value=\"$verein1\"><input type=hidden name=index value=\"$vv\"><input type=hidden name=verein2 value=\"$verein2\"></form>\n";
}

print "</td>\n";
print "<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td align=left valign=top nowrap=nowrap><font face=verdana size=1><img src=/img/loch.JPG><br>\n";
...
print "<font face=verdana size=2><b><a href=javascript:document.d1.submit()>Ergebnisse und Anstosszeiten der Tipformular Paarungen</a></b>\n";
