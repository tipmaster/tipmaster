...
my $tor="";my $datei="";my $query; my $liga; my $verein; 
...
print "<!-- datei ist $datei ss_saison is $ss_saison main_nr is $main_nr... array size " .scalar(@main_kuerzel)." //-->\n";
print "<!-- @main_kuerzel //-->\n";
open(D2,"$datei");
while(<D2>) {
$lo++;
...
print "<form name=tr method=post action=/cgi-mod/btm/trainer.pl target=_top><input type=hidden name=ident value=\"$datb[$verein]\"></form>\n";
...
if ( $c > 4 ) {
print "<td align=center bgcolor=#E6E8FC><font face=verdana size=1>&nbsp;<a href=javascript:document.u$c.submit()><img src=/img/h1.jpg alt=\"Archivtabelle $saison[$c]\" border=0></a>&nbsp;</td></form>\n";
} else {
...
print "<td align=left bgcolor=$color><font face=verdana size=1>&nbsp;$liga_namen[$sat[$c]] &nbsp;&nbsp; &nbsp; </td>";
$rr ="";
if ( $sai[$c] < 10 ) { $rr = "0" }
...
if ( $basis[$c] > $basis[$d] ) {
print "<td align=center bgcolor=#cfd0e4><font face=verdana size=1>&nbsp;&nbsp;<img src=/img/pfeil+.gif border=0>&nbsp;&nbsp;</td>";
}

if ( $basis[$c] == $basis[$d] ) {

if ( $sai[$c] == 1 && $sat[$c] == 1 ) { 
print "<td align=center bgcolor=#cfd0e4><font face=verdana size=1>&nbsp;&nbsp;<img src=/img/pfeils.gif border=0>&nbsp;&nbsp;</td>";
...
$ac=$bongo[2];
$ac=~s/ /%20/g;
print "<td align=lef bgcolor=#E6E8FC><font face=verdana size=1>&nbsp;Von $saison[$saison_start] | Sp. $aa &nbsp;</td>";
print "<td align=lef bgcolor=#E6E8FC><font face=verdana size=1>&nbsp;Bis $saison[$saison_ende] | Sp. $ab &nbsp;</td>";

print "<td align=lef bgcolor=#eeedff><font face=verdana size=1>&nbsp;<a href=/cgi-mod/btm/trainer.pl?ident=$ac><img src=/img/h1.jpg alt=\"Trainerprofil $bongo[2]\" border=0></a>&nbsp;&nbsp;$bongo[2] &nbsp;</td>";
...
print "<td align=left valign=top><font face=verdana size=1>&nbsp;&nbsp;&nbsp;&nbsp;<u>Saisonverlauf $saison[$ss_saison]</u><br>";
...
print  "<TD class=l><a href=/cgi-mod/btm/verein.pl?li=$liga&ve=$gegner[$spieltag]><img src=/img/h1.jpg border=0></a>&nbsp; $data[$gegner[$spieltag]]</td> \n";
$rf = "0";
...
print  "<TD class=c><a href=/cgi-mod/btm/tips.pl?li=$liga&sp=$ss&ve=$tip[$spieltag] target\"_blank\" onClick=\"targetLink('/cgi-mod/btm/tips.pl?li=$liga&sp=$ss&ve=$tip[$spieltag]');return false\"><IMG SRC=/img/ti.jpg BORDER=0></A></td> \n";
} else {
...
print "<td class=r >  <a href=/cgi-bin/head2head.pl?loc=btm&id1=$gl_vereinsid{$data[$verein]}&id2=$gl_vereinsid{$data[$gegner[$spieltag]]} target=bilanz>$return[0] - $return[1] - $return[2]</a> &nbsp; &nbsp; ";
print "<td bgcolor=black><SPACER TYPE=BLOCK WIDTH=1 HEIGHT=1></td>\n";
print  "</tr>";
