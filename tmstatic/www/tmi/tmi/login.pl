...
my $id = "";my @datc = ();my $leute = "";my $c1 = "";my $c2 = "";my $c3 = "";my $c6 = "";my $c7 = "";my $c8 = "";my $c9 = "";my $c11="";my $c10 = "";my $c5 = "";my $c4="";
...
open (D1 , "</tmdata/master.txt") ;$master = <D1> ;chomp $master ;close (D1) ;
open (D1 , "</tmdata/top_tip.txt") ;$run = <D1> ;my $top_tip_aktiv=<D1>;chomp $run ;
chomp $top_tip_aktiv;close (D1) ;

@liga_namen = ( "---" , "ITA I" , "ITA II" , "ITA III/A" , "ITA III/B" , "ITA IV/A" , "ITA IV/B"  , "ITA IV/C" , "ITA IV/D" ,
...
print "<a class=navis href=/cgi-bin/online_who.pl target\"_blank\" onClick=\"targetLink('/cgi-bin/btm/online_who.pl');return false\">Wer ist gerade online ?</a>";
...
if (!-e $datei ) {
print "<tr><td align=center colspan=2><br><font face=verdana size=1 color=black>*** Sie haben <font color=darkred>Ihr Trainerprofil<font color=black> noch nicht angelegt ***<br>*** Dies koennen Sie ueber den unteren Link <font color=darkred> 'Profil verwalten'  <font color=black> nacholen ***<br></td></tr>\n";
}
print "</td></tr></table>\n";
...
print "<td align=center colspan=5 bgcolor=#E1E6F0><font face=verdana size=1>Bet5.net Gewinnspiel Aktuelle Wochenwertung<br>
...
print "<td align=left bgcolor=#e6e6fa><font face=verdana size=1 color=$color>&nbsp;&nbsp;<img src=/img/$ima alt=\"von Platz $ex_platz[$x]\">&nbsp;&nbsp;<a href=/cgi-bin/btm/show_tip.pl?trainer=$ff target\"_blank\" onClick=\"targetLink('/cgi-bin/btm/show_tip.pl?trainer=$ff');return false\"><img src=/img/tt4.JPG border=0 alt=\"Bisherige Tips von $bonus[$x] anzeigen\"></a> &nbsp;&nbsp;$bonus[$x] &nbsp; &nbsp; </td>\n";
$pi[$x] = $pi[$x] * 1;
...
if ( $top_tip_platz > 5 ) {
print "<tr>\n";
print "<td align=right bgcolor=#eeeeff nowrap><font face=verdana size=1> &nbsp;&nbsp;$top_tip_platz.&nbsp;</td>\n";
print "<td align=left bgcolor=#e6e6fa nowrap><font face=verdana size=1 color=darkred>&nbsp;&nbsp;<img src=/img/pfeil=.gif>&nbsp;&nbsp;<a href=/cgi-bin/btm/show_tip.pl?trainer=$ff target\"_blank\" onClick=\"targetLink('/cgi-bin/btm/show_tip.pl?trainer=$ff');return false\"><img src=/img/tt4.JPG border=0 alt=\"Bisherige Tips von $leut anzeigen\"></a>  &nbsp;&nbsp;$leut &nbsp; &nbsp; </td>\n";

print "<td align=center bgcolor=#eeeeff nowrap><font face=verdana size=1>&nbsp;----&nbsp;</td>\n";
print "<td align=center bgcolor=#e6e6fa nowrap><font face=verdana size=1>&nbsp;$top_tip_punkte Pu.&nbsp;</td>\n";
...
print "<font face=verdana size=2 color=darkred>Am heutigen Tag gibt es (noch) kein\n<br>Spiel bei Bet5.net  zu tippen !</b>\n";
...
print "<tr><td colspan=2 align=left bgcolor=#E1E6F0><font size=2>&nbsp;<font face=verdana size=1>Bet5.net Spiele</td></tr>\n";
...
print "<tr><td colspan=1 align=left bgcolor=#eeeeff><font face=tahoma size=1>&nbsp;$date[$x] $zeit[$x] Uhr&nbsp;&nbsp;&nbsp;$gegner1[$x] - $gegner2[$x]&nbsp;&nbsp;&nbsp;&nbsp;</td><td colspan=1 align=center bgcolor=#cbccff><font face=verdana size=1>&nbsp;$tore_a{$nr[$x]}&nbsp;:&nbsp;$tore_b{$nr[$x]}&nbsp;</td></tr>\n";
}
