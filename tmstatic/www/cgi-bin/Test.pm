...
sub btm_liga_namen {
my @liga_namen = ( "---" , "1.Bundesliga" , "2.Bundesliga" ,"Regionalliga A" ,"Regionalliga B" ,"Oberliga A" ,"Oberliga B" ,"Oberliga C" ,"Oberliga D" ,
...
"Saison 2015'1" ,  "Saison 2015'2" ,  "Saison 2015'3" ,  "Saison 2015'4" ,   "Saison 2015'5" , "Saison 2015'6" ,

) ;

open (D1,"</tmdata/btm/main_nr.txt");$main_saison[0]=<D1>;chomp $main_saison[0];close(D1);
return @main_saison;
}
...
open (D1,"</tmdata/tmi/main_nr.txt");$main_saison[0]=<D1>;chomp $main_saison[0];close(D1);
return @main_saison;
}
...
my $sek = "";my $min = "";my $std = "";my $tag = "";my $mon = "";my $jahr = "";my $ww = "";my $ran = "";my $jja = "";my $jjm = "";my $jjj = "";
my $xx1 = "";my @kampagnen_id = ();my @kampagnen_img = ();my @kampagnen_url = ();my $mleg = "";my $go = "";my $xa1 = "";my $xb1 = "";my $xc1 = "";my $xd1 = "";
my $xe1 = "";my $xf1 = "";my $xg1 = "";my $gg1 = "";my $dateiname = "";my $r = "";my $ver = "";my @banner_url=();my @sponsor_fir=();my $aaff="";
my $number = "";
srand();
$gg1 = int(10*rand)+44 ;
