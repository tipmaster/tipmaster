...
print "";
print "<form method=post action=/cgi-bin/tmi/vranking.pl target=_top>\n";
print "<font face=verdana size=2><b>TMI - Vereinsranking</b> &nbsp;

<!--&nbsp; &nbsp; <font size=1>[ Eine inoffizielle europaeische Vereinsrangliste gibt es <a href=http://mypage.bluewindow.ch/worldofpapajoe/evr.htm target=new>hier</a> zu begutachten ]-->
...
next if !$verein[$ident[$t]];
$img="";


print "<tr>\n";
print "<td bgcolor=$col align=right><font face=verdana size=1 color=$color>&nbsp;$img&nbsp;".($t - 1).". &nbsp;</td>\n";
$aa=$verein[$ident[$t]];
$aa=~s/ /%20/g ;
$colore="#eeeeff";
if ( $sai == $ligav{$verein[$ident[$t]]} ) { $colore="#e3e4ff" }
print "<td bgcolor=$colore align=left><font face=verdana size=1 color=$color>&nbsp;&nbsp;<a href=/cgi-mod/tmi/verein.pl?ident=$aa><img src=/img/h1.jpg border=0 alt=\"Vereinsstatistik $verein[$ident[$t]]\"></a>&nbsp;&nbsp;$verein[$ident[$t]] &nbsp; &nbsp; &nbsp; </td>\n";
