...
print "&nbsp; Bei der TipMaster.net Suche koennen Sie alle <font color=deepblue>Vereinsnamen<font color=black> und <font color=deepkblue>Trainernamen<font color=black><br>\n";
