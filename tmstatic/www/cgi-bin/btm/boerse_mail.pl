...
print "<form name=Testform action=/cgi-bin/btm/boerse.pl method=post><input type=hidden name=trainer value=\"$trainer\"><input type=hidden name=pass value=\"$pass\"></form>";
...
print "<br><br><font face=verdana size=2><b>Sehr geehrte(r) $trainer ,</b><font face=verdana size=1><br><br>es wurden folgende Bewerbungen von Ihnen an diese Vereine verschickt :<br><br>\n";
...
print "Ihre aktuelle Bewerbungs - Plazierung koennen Sie jederzeit<br>auf der Seite der Job - Boerse abfragen .<br>";
print "<br><font color=darkred>Achtung: Wenn Sie den Verein ueber die Job - Boerse wechseln ist bis zum Freitag<br>bereits eine Tipabgabe fuer Ihren neuen Verein notwendig da Ihnen sonst eine<br>verpasste Tipabgabe angerechnet wird - auch wenn sie fuer ihren alten Verein<br>bereits getippt haben.<br>\n";
...
print "<br><font face=verdana size=1>Sehr geehrte(r) $trainer ,<br><br>es wurden von Ihnen keine Vereine zur Bewerbung ausgewaehlt<br>beziehungsweise alle ihre Bewerbungen wurden ruckgaengig gemacht .<br><br><br><br>Sie werden in 10 Sek. zur Menuseite weiter geleitet ...";
}
exit ;
